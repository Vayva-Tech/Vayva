...
import { Tent, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-stone-100">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-green-700 to-emerald-800 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Contact Us</h1>
          <p className="text-green-100">We&apos;re here to help you gear up for adventure</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 border border-stone-200">
              ...
              <form className="space-y-4">
                ...
                <button type="submit" className="w-full px-6 py-3 bg-green-700 text-white font-semibold rounded-lg hover:bg-green-800">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@campout.com</p>
                    <p className="text-gray-600">gear@campout.com</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-CAMPOUT</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Flagship Store</h3>
                    <p className="text-gray-600">789 Trailhead Way</p>
