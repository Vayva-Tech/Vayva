...
import { Backpack, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-stone-100">
      ...
      <section className="bg-gradient-to-br from-stone-700 to-stone-800 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-stone-300">Reach out for gear advice and support</p>
        </div>
      </section>
              ...
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@gearvault.com</p>
                    <p className="text-gray-600">support@gearvault.com</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-GEARVAULT</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">456 Gear Street</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon-Fri: 10am - 7pm</p>
