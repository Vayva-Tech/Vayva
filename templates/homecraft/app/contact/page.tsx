...
import { Hammer, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-amber-600 to-orange-700 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Contact Us</h1>
          <p className="text-amber-100">Questions about your DIY project? We&apos;re here to help</p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@homecraft.com</p>
                    <p className="text-gray-600">support@homecraft.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-HOMECRAFT</p>
                    <p className="text-gray-500 text-sm">Mon-Sat 8am-6pm EST</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Workshop</h3>
                    <p className="text-gray-600">789 Builder Ave</p>
