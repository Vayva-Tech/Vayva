...
import { Scissors, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
              ...
              <form className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Craft Interest</label>
                ...
                <div>
                  ...
                  <textarea rows={5} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent" />
                </div>
                <button type="submit" className="w-full px-6 py-3 bg-rose-500 text-white font-semibold rounded-lg hover:bg-rose-600">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 border border-rose-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@craftcorner.com</p>
                    <p className="text-gray-600">support@craftcorner.com</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-rose-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-CRAFT</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-rose-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Craft Studio</h3>
                    <p className="text-gray-600">789 Creative Lane</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-rose-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sun: 11am - 5pm</p>
                  </div>
                </div>
              </div>
            </div>
