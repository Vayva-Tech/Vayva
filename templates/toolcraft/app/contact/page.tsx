...
import { Wrench, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-amber-600 to-yellow-700 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Contact Us</h1>
          <p className="text-amber-100">Get in touch with our tool experts</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200">
              ...
              <form className="space-y-4">
                ...
                <button type="submit" className="w-full px-6 py-3 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-700">
                  Send Message
                </button>
              </form>
            </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@toolcraft.com</p>
                    <p className="text-gray-600">support@toolcraft.com</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-TOOLCRAFT</p>
                    <p className="text-gray-500 text-sm">Mon-Fri 7am-7pm EST</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">789 Industrial Way</p>
                    <p className="text-gray-600">Milwaukee, WI 53201</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon-Fri: 7am - 7pm EST</p>
                    <p className="text-gray-600">Sat: 8am - 4pm EST</p>
                  </div>
                </div>
              </div>
            </div>
