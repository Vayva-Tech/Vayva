...
import { Cat, ArrowLeft, Mail, MapPin, Phone, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <section className="bg-gradient-to-br from-orange-500 to-amber-500 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-orange-100">We&apos;re here for you and your pets</p>
        </div>
      </section>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                    ...
                    <option>Pet Advice</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Message</label>
                  <textarea rows={5} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-orange-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@petpal.com</p>
                    <p className="text-gray-600">support@petpal.com</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-orange-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1-800-PETPAL</p>
              ...
              <div className="bg-white rounded-xl p-6 border border-orange-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sat-Sun: 9am - 5pm EST</p>
                  </div>
                </div>
              </div>
            </div>
