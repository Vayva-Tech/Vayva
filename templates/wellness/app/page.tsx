...
import { Heart, ShoppingBag, Sparkles, Droplets, Leaf, Wind, Sun, Moon, Package, Truck, Star, Plus } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">Wellness</span>
            </Link>
            <div className="hidden md:flex items-center gap-8">
              <Link href="/skincare" className="text-muted-foreground hover:text-foreground transition-colors">Skincare</Link>
              <Link href="/wellness" className="text-muted-foreground hover:text-foreground transition-colors">Wellness</Link>
              <Link href="/spa" className="text-muted-foreground hover:text-foreground transition-colors">Spa</Link>
            </div>
      ...
      <section className="section-padding bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block px-4 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium mb-4">Self-Care Essentials</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
                Nurture Your <span className="text-primary">Mind</span> & Body
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Premium wellness products for your self-care journey. Natural, cruelty-free, and made with love.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/rituals" className="px-8 py-3 bg-card text-foreground font-medium rounded-lg border hover:bg-accent/10 transition-colors">Daily Rituals</Link>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-card rounded-2xl shadow-xl p-6 border">
                ...
                <div className="text-muted-foreground">Wellness Lovers</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl font-bold text-primary-foreground mb-4">Join the Wellness Club</h2>
          <p className="text-primary-foreground/80 mb-8">Get 15% off your first order and exclusive self-care tips</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Premium self-care products for your wellness journey.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Shop</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="/skincare" className="hover:text-foreground">Skincare</Link></li>
                <li><Link href="/wellness" className="hover:text-foreground">Wellness</Link></li>
                <li><Link href="/spa" className="hover:text-foreground">Spa at Home</Link></li>
              </ul>
            </div>
            <div>
...
const categories = [
  { name: "Skincare", href: "/skincare", icon: Sparkles },
  { name: "Bath", href: "/bath", icon: Droplets },
  { name: "Aromatherapy", href: "/aromatherapy", icon: Leaf },
  { name: "Wellness", href: "/wellness", icon: Wind },
  { name: "Sleep", href: "/sleep", icon: Moon },
  { name: "Meditation", href: "/meditation", icon: Sun },
];

const products = [
  { name: "Glow Serum", category: "Skincare", price: "$48", rating: "4.9", badge: "Bestseller" },
  { name: "Relax Bath Set", category: "Bath & Body", price: "$65", rating: "4.8", badge: null },
  { name: "Essential Oil Kit", category: "Aromatherapy", price: "$89", rating: "4.7", badge: "New" },
  { name: "Sleep Mist Spray", category: "Sleep", price: "$28", rating: "4.9", badge: null },
];

const features = [
  { title: "Cruelty-Free", desc: "Never tested on animals", icon: Heart },
  { title: "Natural Ingredients", desc: "Plant-based formulas", icon: Leaf },
  { title: "Free Shipping", desc: "Orders over $50", icon: Truck },
  { title: "Eco Packaging", desc: "100% recyclable", icon: Package },
];
