    ...
    const products = [
      {
        ...
        description:
          "Premium 100% cotton oversized graphic tee featuring exclusive Numba artwork. Heavyweight fabric (220gsm) with ribbed crew neck and dropped shoulders. Perfect for the modern streetwear enthusiast.",
      ...
      },
      {
        ...
        description:
          "Tactical-inspired cargo pants with multiple utility pockets. Durable ripstop fabric with adjustable waist and tapered fit. Features reinforced knees and water-resistant coating.",
        price: 2800000,
      ...
      },
      {
        ...
        description:
          "Premium snapback with 3D embroidered Numba logo. Structured 6-panel crown with flat brim and adjustable snapback closure. Breathable eyelets and moisture-wicking sweatband.",
        price: 1200000,
      ...
      },
      {
        ...
        description:
          "Heavyweight pullover hoodie with premium fleece interior. Features kangaroo pocket, drawstring hood, and ribbed cuffs. Oversized fit with dropped shoulders for ultimate comfort.",
        price: 3500000,
      ...
      },
      {
        ...
        description:
          'Durable canvas crossbody bag with adjustable strap. Multiple compartments including padded laptop sleeve (13"). Water-resistant coating and YKK zippers. Perfect for daily carry.',
        price: 1800000,
