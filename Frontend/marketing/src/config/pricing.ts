...
export const PLANS: Plan[] = [
  {
    ...
    trialDays: 7,
    bullets: [
      "AI order capture for WhatsApp & Instagram",
      "Paystack checkout: cards, transfers, USSD, and mobile money",
      "Inventory tracking + low-stock alerts",
      "Delivery management + status updates",
      "1 staff seat",
      "Up to 100 products",
      "1 storefront template included (more available to purchase)",
      "Vayva subdomain storefront (custom domain on Pro and above)",
    ],
    ctaLabel: "Start with Starter",
  ...
  },
  {
    ...
    bullets: [
      ...
      "3 staff seats",
      "Up to 300 products",
      "2 storefront templates included (more available to purchase)",
      "Custom domain support",
      "Advanced operations + finance tools",
  ...
  },
  {
    ...
    bullets: [
      ...
      "5 staff seats",
      "Up to 500 products",
      "5 storefront templates included (more available to purchase)",
      "Industry dashboards + merged industry view",
