  ...
  return (
    <div className="relative py-24 px-6">
      <div className="max-w-[1600px] mx-auto px-6">
        ...
        <div className="mt-16 grid lg:grid-cols-[1fr_1.1fr] gap-12">
          <motion.div
          ...
          >
            {contactContent.sections.map((section) => (
              <div key={section.title} className="relative">
                ...
                <div className="relative rounded-[28px] border-2 border-slate-900/10 bg-white/90 backdrop-blur p-6 shadow-[0_16px_38px_rgba(15,23,42,0.1)]">
                ...
                return (
                  <div key={social.label} className="relative">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="relative w-11 h-11 rounded-full border-2 border-slate-900/10 bg-white/90 flex items-center justify-center text-slate-500 hover:text-emerald-700 hover:border-emerald-200 transition-all shadow-[0_10px_22px_rgba(15,23,42,0.08)]"
          ...
          >
            ...
            <div className="relative rounded-[32px] border-2 border-slate-900/10 bg-white/85 backdrop-blur p-8 shadow-[0_24px_60px_rgba(15,23,42,0.12)]">
            {status === "success" ? (
