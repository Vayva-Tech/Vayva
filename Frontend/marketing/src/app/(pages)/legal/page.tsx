  ...
  return (
    <div className="relative w-full min-w-0 overflow-x-hidden text-slate-900">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-12 sm:py-16 min-w-0">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 min-w-0 lg:h-[calc(100vh-72px)] lg:overflow-hidden">
          <aside className="w-full lg:w-72 shrink-0 min-w-0 lg:overflow-hidden">
            <div className="lg:h-full lg:pr-2">
              <nav
                className="rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-sm lg:h-full lg:overflow-y-auto lg:overscroll-contain"
          ...
          <main className="flex-1 max-w-3xl lg:max-w-none lg:overflow-y-auto lg:overscroll-contain lg:pr-2">
            <div className="mb-12">
