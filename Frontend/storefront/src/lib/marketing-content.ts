...
> = {
  ...
  [TemplateCategory.AUTOMOTIVE]: {
    ...
    subheadline:
      "Manage inventory, VIN specs, and lead generation for auto sales.",
  },
  [TemplateCategory.TRAVEL]: {
    headline: "Elegant booking experience for hospitality.",
    subheadline:
      "Showcase rooms, manage availability, and take direct reservations.",
  },
  ...
  [TemplateCategory.ONE_PRODUCT]: {
    ...
    subheadline:
      "Focus all traffic on one hero product with an optimized funnel.",
  },
};
