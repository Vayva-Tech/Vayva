...
// @ts-expect-error -- storefront types may not be resolved in all TS configs
import { PublicStore, PublicProduct, StorefrontOneProductConfig } from "@/types/storefront";
...
export const OneProductLayout = ({
  ...
  const config: StorefrontOneProductConfig = store.theme?.oneProductConfig || {};
  ...
  return (
    <div className="min-h-screen bg-transparent font-sans text-gray-900 pb-20 md:pb-0">
      ...
      <StickyCTA price={activeProduct.price || 0} onBuy={() => handleBuy(1)} />
