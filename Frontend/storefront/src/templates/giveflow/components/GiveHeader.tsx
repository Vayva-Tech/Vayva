...
import { Heart, List as Menu, MagnifyingGlass as Search } from "@phosphor-icons/react/ssr";
...
export const GiveHeader = ({
  storeName,
}: GiveHeaderProps): React.JSX.Element => {
  return (
    <header className="sticky top-0 z-50 bg-transparent shadow-sm border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="icon"
            className="text-gray-400 hover:text-gray-900 md:block hidden h-auto"
            aria-label="Search"
          >
            <Search size={20} />
          </Button>
