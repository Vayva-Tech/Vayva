...
import { ShoppingBag, MagnifyingGlass as Search } from "@phosphor-icons/react/ssr";
...
export const MobileHeader = ({
  ...
  return (
    <header className="sticky top-0 z-50 bg-transparent border-b border-gray-200 h-[60px] flex items-center justify-between px-4 shadow-sm">
      ...
      <div className="flex items-center gap-5 text-[#0B0F19]">
        <Button
          variant="ghost"
          size="icon"
          className="p-1 hover:text-blue-600 transition-colors h-auto"
          aria-label="Search"
        >
