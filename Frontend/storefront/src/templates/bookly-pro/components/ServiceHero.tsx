...
export const ServiceHero = ({
  ...
  return (
    <section className="bg-transparent py-12 px-6 border-b border-gray-100">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1 space-y-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start pt-2">
            <Button
              className="bg-gray-900 text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-gray-800 transition-all h-auto"
            ...
            <Button
              variant="ghost"
              className="text-gray-600 font-medium hover:text-blue-600 px-4 h-auto"
        ...
        <div className="flex-1 w-full relative aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden bg-background/50 backdrop-blur-sm">
          <img
