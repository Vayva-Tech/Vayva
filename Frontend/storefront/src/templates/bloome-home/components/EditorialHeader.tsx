...
import { ShoppingBag, MagnifyingGlass as Search, List as Menu } from "@phosphor-icons/react/ssr";
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#FAFAF9]/90 backdrop-blur-sm border-b border-stone-200 h-[70px] flex items-center justify-between px-6 transition-all duration-300">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="p-2 -ml-2 hover:bg-stone-100 rounded-full text-stone-600 transition-colors h-auto"
      ...
      <div className="flex items-center gap-4 text-stone-600">
        <Button
          variant="ghost"
          size="icon"
          className="p-2 hover:text-[#C9B7A2] transition-colors h-auto"
          aria-label="Search"
        >
