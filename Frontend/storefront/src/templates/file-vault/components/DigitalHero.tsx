...
import { ShieldCheck, Lightning as Zap } from "@phosphor-icons/react/ssr";
    ...
    <section className="bg-[#0B0F19] pt-20 pb-24 px-6 border-b border-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            className="w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-900/50 h-auto"
