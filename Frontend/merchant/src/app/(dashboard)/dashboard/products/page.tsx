...
export default function ProductsPage() {
  ...
  const products: Product[] = useMemo(() => {
    ...
    return raw.map((p: any) => ({
      ...
      sku: p.sku || p.id || "",
      dateAdded:
        p.dateAdded || p.createdAt || p.created_at || new Date().toISOString(),
    }));
  }, [productsData]);
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1 max-w-sm">
              Something went wrong while fetching your products. Please try
              again.
            </p>
            <Button
              onClick={() => mutate()}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="flex flex-col items-center justify-center py-24 px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2 max-w-md">
              Get started by adding products to your catalog. You can add them
              one by one or import in bulk.
            </p>
              ...
              return (
                ...
                >
                  ...
                  <div className={`${product.color} h-48 w-full relative`}>
                    ...
                    >
                      <Button
                        className="p-2 rounded-xl bg-white/90 text-gray-700 hover:bg-white transition-colors"
                        title="Edit"
                      ...
                      <Button
                        className="p-2 rounded-xl bg-white/90 text-red-600 hover:bg-white transition-colors"
                        title="Delete"
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <span
                        className={`text-xs font-medium ${product.stock === 0 ? "text-red-500" : product.stock <= 5 ? "text-amber-500" : "text-gray-500"}`}
                      >
                        {product.stock === 0
                          ? "Out of stock"
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-10 h-10 rounded-xl ${product.color} flex items-center justify-center flex-shrink-0`}
                            >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`text-sm font-medium ${product.stock === 0 ? "text-red-500" : product.stock <= 5 ? "text-amber-500" : "text-gray-700"}`}
                          >
                            {product.stock === 0
                              ? "Out of stock"
                              : product.stock}
