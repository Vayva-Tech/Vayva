    ...
    >
      <div className="grid md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 space-y-6">
          ...
          {/* Persona Settings */}
          <div
            className={`bg-white  p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4 ${status !== "connected" ? "opacity-50 pointer-events-none" : ""}`}
          >
        ...
        <div className="md:col-span-8 space-y-6">
          {/* Feature Toggle */}
          <div className="bg-white  p-6 rounded-2xl border border-green-500/20  flex justify-between items-center">
            <div>
            ...
            <div className="flex-1 p-6 space-y-4 overflow-y-auto bg-white ">
              ...
              {testInput && isTesting && (
                <div className="flex justify-end">
                  <div className="bg-green-500/10 text-green-600 p-3 rounded-2xl rounded-tr-none max-w-[80%] shadow-sm">
                    {testInput}
                  </div>
                </div>
              )}
              ...
              {testResponse && (
                <div className="flex justify-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-500/10 flex items-center justify-center text-xs font-bold text-green-600">
                    AI
                  </div>
                  <div className="bg-white  p-3 rounded-2xl rounded-tl-none border shadow-sm max-w-[80%] text-gray-900">
                    {testResponse}
                  </div>
                </div>
              )}
