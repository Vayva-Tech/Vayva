      ...
      <Card className="p-4">
              ...
              <Card className="p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-green-500/10 flex items-center justify-center overflow-hidden">
                      {instructor.profileImageUrl ? (
                        ...
                        <InstructorIcon className="w-7 h-7 text-green-600" />
                      )}
                    </div>
        ...
        {instructors.length === 0 && (
          <div className="text-center py-12">
            <InstructorIcon className="w-12 h-12 mx-auto text-gray-500 mb-4" />
