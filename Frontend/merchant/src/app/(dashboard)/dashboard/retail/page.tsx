/**
 * Retail Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/retail", icon: Home, active: true },
  { label: "POS / Sales", href: "/dashboard/retail/pos", icon: ShoppingCart },
  { label: "Inventory", href: "/dashboard/retail/inventory", icon: Package },
  { label: "Customers", href: "/dashboard/retail/customers", icon: Users },
  
  // INDUSTRY-SPECIFIC
  { label: "Product Catalog", href: "/dashboard/retail/catalog", icon: Tag },
  { label: "Purchase Orders", href: "/dashboard/retail/purchase-orders", icon: Truck },
  { label: "Staff", href: "/dashboard/retail/staff", icon: Users },
  { label: "Store", href: "/dashboard/retail/store", icon: Store },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/retail/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/retail/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/retail/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/retail/settings", icon: Settings },
];

export default function RetailDashboardHub() {
  return (
    <ErrorBoundary componentName="Retail Dashboard Hub">
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <Breadcrumbs
            items={[
              { label: "Dashboard", href: "/dashboard" },
              { label: "Retail", href: "/dashboard/retail" },
            ]}
          />
        </div>
