  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {/* Tool Selection */}
        <Card className="lg:col-span-1 bg-white rounded-2xl border border-gray-100">
          <CardHeader>
            <CardTitle className="text-sm font-medium text-gray-900">Select Tool</CardTitle>
          </CardHeader>
        ...
        <Card className="lg:col-span-2 bg-white rounded-2xl border border-gray-100">
          <CardHeader>
            <div className="flex items-center gap-2">
              <currentTool.icon className="h-5 w-5 text-green-600" />
              <CardTitle className="text-lg font-semibold text-gray-900">{currentTool.name}</CardTitle>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white rounded-xl font-medium"
            >
              {loading ? (
                <>
      ...
      <Card className="bg-white rounded-2xl border border-gray-100">
        <CardHeader>
          <CardTitle className="text-sm font-semibold text-gray-900">Tips for Best Results</CardTitle>
        </CardHeader>
        <CardContent>
