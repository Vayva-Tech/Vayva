/**
 * Government Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/government", icon: Home, active: true },
  { label: "Citizens", href: "/dashboard/government/citizens", icon: Users },
  { label: "Services", href: "/dashboard/government/services", icon: Building },
  { label: "Cases", href: "/dashboard/government/cases", icon: FileText },
  
  // INDUSTRY-SPECIFIC
  { label: "Applications", href: "/dashboard/government/applications", icon: Clipboard },
  { label: "Permits", href: "/dashboard/government/permits", icon: FileText },
  { label: "Public Events", href: "/dashboard/government/events", icon: Calendar },
  { label: "Staff", href: "/dashboard/government/staff", icon: Users },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/government/finance", icon: DollarSign },
  { label: "Analytics", href: "/dashboard/government/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/government/settings", icon: Settings },
];

export default function GovernmentDashboardHub() {
  return (
    <ErrorBoundary componentName="Government Dashboard Hub">
          ...
          <aside className="w-64 bg-white border-r border-gray-200 min-h-screen p-4 fixed left-0 top-[73px] overflow-y-auto">
            <nav className="space-y-1">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <a
                  href="/dashboard/government/staff"
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Public services, cases, and citizen management
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <MetricCard
                ...
                change={-8}
                trend="down"
                icon={<Clipboard size={16} className="text-purple-600" />}
              />
              <MetricCard
