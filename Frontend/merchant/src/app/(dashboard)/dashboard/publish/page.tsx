    ...
    return (
      <div className="space-y-10 max-w-6xl pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 h-[400px] bg-white animate-pulse rounded-[40px]" />
          <div className="h-[400px] bg-white animate-pulse rounded-[40px]" />
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-10 max-w-6xl pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          {/* Status Block */}
          <div className="relative rounded-[40px] border border-gray-100 bg-gray-50  overflow-hidden group shadow-2xl transition-all duration-500 hover:border-green-500/20">
            <div className="absolute -top-32 -right-32 w-96 h-96 bg-green-500/5 rounded-full blur-[100px] pointer-events-none group-hover:bg-green-500/10 transition-colors duration-700" />

            <div className="p-10 space-y-8">
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 rounded-2xl bg-green-500/10 flex items-center justify-center shadow-2xl shadow-primary/10 transition-transform duration-500 group-hover:scale-110">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {site?.lastPublishedAt && (
                      <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-6 rounded-[24px] bg-white border border-gray-100 space-y-3">
              ...
              <div className="pt-4 flex items-center gap-4">
                <Button
                  ...
                  className="rounded-2xl h-14 px-8 gap-3 bg-text-green-600 text-white hover:bg-zinc-800 shadow-xl active:scale-95 transition-all disabled:opacity-50"
                >
                  {publishing ? (
                ...
                <Button
                  ...
                  className="rounded-2xl h-14 px-8 border-gray-100 hover:bg-white hover:border-gray-200 transition-all active:scale-95"
                >
        ...
        <div className="space-y-6">
          <div className="p-8 rounded-[32px] border border-gray-100 bg-green-500/5 space-y-4">
            <div className="h-12 w-12 rounded-[18px] bg-green-500/10 flex items-center justify-center">
          ...
          <div className="p-8 rounded-[32px] border border-gray-100 bg-gray-50  space-y-4">
