  ...
  return (
    <div className="max-w-6xl space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* System Roles */}
        <Card className="p-6 bg-white border-dashed">
        ...
        <div className="md:col-span-2 space-y-4">
          <h3 className="font-bold uppercase text-xs tracking-widest text-green-600">
            Custom Roles
          </h3>
          {isLoading ? (
            ...
            <div className="p-12 text-center border-2 border-dashed rounded-2xl text-gray-500">
