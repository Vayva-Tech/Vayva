      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="rounded-[20px] border border-gray-100 bg-white  p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-900">Bottom Tabs (4 slots)</h2>
          ...
          <div className="space-y-3">
            {config?.tabs?.map((tab: any, index: number) => (
              <div
                key={`${tab}-${index}`}
                className="rounded-2xl border border-gray-100 bg-gray-50 p-3 flex flex-wrap items-center gap-3"
              >
                ...
                <Select
                  ...
                  className="h-10 px-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 min-w-[180px]"
        ...
        <section className="rounded-[20px] border border-gray-100 bg-white  p-5 space-y-4">
          <div>
            <h2 className="text-sm font-bold text-gray-900">Hide from More</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {MOBILE_NAV_AVAILABLE_TABS.filter((tabId: MobileNavTab) => tabId !== "home").map((tabId: MobileNavTab) => {
              ...
              return (
                <label
                  key={tabId}
                  className="rounded-2xl border border-gray-100 bg-gray-50 p-3 flex items-start gap-3"
                >
                  <Checkbox
