/**
 * Restaurant Marketing Page - Loyalty Programs & Promotions
 */
"use client";
          ...
          <CardContent>
            {campaigns.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">No Marketing Campaigns Yet</h3>
                <p className="text-muted-foreground mb-4">Create promotions and loyalty programs to attract customers</p>
                <Button>
                  <Plus className="h-4 w-4 mr-2" />
                  Create Campaign
                </Button>
                ...
                <TableBody>
                  {campaigns.map((campaign) => (
                    <TableRow key={campaign.id}>
                      ...
                      <TableCell className="font-semibold">{campaign.conversionRate}%</TableCell>
