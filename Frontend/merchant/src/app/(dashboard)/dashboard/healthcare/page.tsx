/**
 * Healthcare Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/healthcare", icon: Home, active: true },
  ...
  // INDUSTRY-SPECIFIC
  { label: "EMR / EHR", href: "/dashboard/healthcare/emr", icon: FileText },
  ...
  { label: "Staff", href: "/dashboard/healthcare/staff", icon: Users },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/healthcare/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/healthcare/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/healthcare/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/healthcare/settings", icon: Settings },
];

export default function HealthcareDashboardHub() {
  return (
    <ErrorBoundary componentName="Healthcare Dashboard Hub">
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Patient care, appointments, and practice management
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <MetricCard
                ...
                change={5}
                trend="up"
                icon={<Stethoscope size={16} className="text-orange-600" />}
              />
            </div>
