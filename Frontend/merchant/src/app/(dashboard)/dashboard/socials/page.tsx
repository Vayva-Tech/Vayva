...
export default function SocialsPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6 max-w-7xl apple-stagger pb-10">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-gray-900">Social Channels</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-white  rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <p className="text-3xl font-black text-gray-900">{aiReport?.totalConversations || 0}</p>
        ...
        <div className="bg-white  rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <p className="text-3xl font-black text-gray-900">{aiReport?.responseRate || 0}%</p>
          <p className="text-xs text-gray-500 mt-1">AI + Manual</p>
        </div>
        <div className="bg-white  rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-3xl font-black text-gray-900">{aiReport?.avgResponseTime || "--"}</p>
          <p className="text-xs text-gray-500 mt-1">First reply</p>
        </div>
        <div className="bg-white  rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-3xl font-black text-gray-900">{aiReport?.satisfactionScore || 0}%</p>
        ...
        <div className="bg-gradient-to-br from-status-danger to-red-600 rounded-xl border border-status-danger p-4 shadow-lg apple-card apple-gpu apple-elastic">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-white font-bold">Needs Attention</p>
            <Icon name="AlertCircle" size={16} className="text-white" />
          </div>
          <p className="text-3xl font-black text-white">{pendingDMs.length}</p>
          <p className="text-xs text-white/80 mt-1">Pending DMs</p>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-hidden bg-white">
          <div className="p-6 h-full overflow-y-auto">
            <div className="max-w-3xl mx-auto bg-white  rounded-xl border border-gray-200 shadow-sm p-6">
              <h2 className="text-lg font-bold text-gray-900">Socials is not enabled</h2>
        ...
        {tab === "whatsapp" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white  rounded-xl border border-gray-200 shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Unread or flagged conversations</p>
                </div>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500 truncate">{conv.lastMessage?.text || "No message"}</p>
                          </div>
                        </div>
                      </div>
                    ))
            ...
            <div className="lg:col-span-2">
              <div className="bg-white  rounded-xl border border-gray-200 shadow-sm h-[700px] flex flex-col">
                <div className="p-4 border-b border-gray-100">
          ...
          <div>
            {ig?.connected ? (
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 apple-stagger">
                <div className="lg:col-span-1">
                  <div className="bg-white  rounded-xl border border-gray-200 shadow-sm">
                    <div className="p-4 border-b border-gray-100">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Unread Instagram DMs</p>
                    </div>
                    <div className="divide-y divide-border/40 max-h-[600px] overflow-y-auto">
                      {pendingDMs.length === 0 ? (
                        <div className="p-8 text-center">
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white  rounded-xl border border-gray-200 p-4 shadow-sm apple-card apple-gpu">
                    <div className="p-4 border-b border-gray-100">
                      <h3 className="font-bold text-black">All Conversations</h3>
                      <p className="text-xs text-gray-500 mt-1">Instagram DMs</p>
                    </div>
                    <div className="flex-1 overflow-hidden flex">
                      <div className="w-80 border-r border-gray-200 flex flex-col">
                        <ConversationList
          ...
          <div className="p-6 h-full overflow-y-auto">
            <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white  p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <p className="text-sm text-gray-700 mb-4">Connect WhatsApp to manage conversations and automate replies.</p>
              ...
              <div className="bg-white  p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <p className="text-sm text-gray-700 mb-4">Connect Instagram to receive and reply to DMs.</p>
