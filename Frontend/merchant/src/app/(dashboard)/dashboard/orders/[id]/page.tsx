          ...
          className={cn(
            ...
            order.riskLevel === "CRITICAL"
              ...
              : order.riskLevel === "HIGH"
                ...
                : "bg-amber-50 border-amber-500/10 text-amber-600-foreground",
          )}
        >
          <div className="flex items-center gap-3">
            <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white  rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-100 bg-white">
              <h2 className="font-bold text-gray-900 flex items-center gap-2 uppercase tracking-tighter text-xs">
                <ShoppingBag className="h-4 w-4 text-gray-500" /> Items
                Summary
              </h2>
            </div>
            <div className="divide-y divide-gray-50">
              {order?.items?.map((item) => (
                <div
                  key={item.id}
                  className="p-6 flex gap-4 hover:bg-white transition-colors"
                >
                  <div className="h-16 w-16 bg-white rounded-xl flex-shrink-0 overflow-hidden border border-gray-100">
            ...
            <div className="bg-white p-6 border-t border-gray-100">
              <div className="flex justify-between items-center bg-white  p-4 rounded-xl border border-gray-100 shadow-sm">
                ...
                <span className="font-black text-2xl text-gray-900 font-mono">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white  p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
            <h2 className="font-bold text-gray-900 uppercase tracking-tighter text-xs border-b border-gray-100 pb-3">
              Payment & Fulfillment
            </h2>
            <div className="space-y-4">
          ...
          <div className="bg-white  p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-xl bg-green-500 text-green-600-foreground flex items-center justify-center font-black text-lg">
            ...
            <div className="flex gap-2">
              <Button className="flex-1 rounded-xl bg-green-500 hover:bg-green-50 text-green-600-foreground font-bold h-11">
          ...
          <div className="bg-white  p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
            <h2 className="font-bold text-gray-900 uppercase tracking-tighter text-xs flex items-center gap-2">
              <MapPin className="h-4 w-4 text-gray-500" /> Delivery
            </h2>
            {order.shippingAddress ? (
              <div className="text-sm font-medium text-gray-700 leading-relaxed bg-white p-4 rounded-xl border border-gray-100">
