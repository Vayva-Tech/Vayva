          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-gray-100">
                {issues.map((shipment) => (
                  <tr key={shipment.id} className="hover:bg-gray-50 group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          className="text-gray-600 hover:text-green-600 hover:bg-gray-100 flex items-center gap-1.5 text-xs font-medium border-gray-200 h-8"
                        >
                        ...
                        <Button
                          ...
                          className="text-gray-600 hover:text-green-600 hover:bg-gray-100 border-gray-200 h-8 w-8"
        ...
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Textarea
                className="flex min-h-[80px] w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="text-white bg-green-500 hover:bg-green-600 font-medium flex items-center gap-2"
            >
