  ...
  return (
    ...
    >
      ...
      <section className="space-y-4" aria-label="Support modules">
        <h2 className="text-lg font-semibold text-gray-900">Support Modules</h2>
        {loading ? (
        ...
        <nav className="flex flex-wrap gap-3" aria-label="Quick action navigation">
          {quickActions.map((action) => {
            ...
            const variantClasses = {
              primary: "bg-green-500 text-white hover:bg-green-500 focus:ring-green-500",
              secondary: "bg-gray-50 text-gray-900 hover:bg-white-tertiary focus:ring-green-500/50",
