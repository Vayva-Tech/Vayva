  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 font-serif">Malpractice & Risk</h1>
          <p className="text-gray-700 mt-1">Incident reporting and insurance information</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-700">Allow staff to report incidents anonymously</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-700">Immediate notification for serious incidents</p>
            </div>
            <input type="checkbox" defaultChecked className="toggle" />
          </div>
        </div>
