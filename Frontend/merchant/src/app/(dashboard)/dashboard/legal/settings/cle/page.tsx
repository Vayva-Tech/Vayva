  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 font-serif">CLE Tracking</h1>
          <p className="text-gray-700 mt-1">Continuing Legal Education credit requirements</p>
        </div>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-700 mt-1">Per reporting period</p>
          </div>
          <div>
            <Label>Ethics Credits Required</Label>
            <Input type="number" defaultValue="4" />
            <p className="text-sm text-gray-700 mt-1">Minimum ethics hours</p>
          </div>
          <div>
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-gray-700 mb-4">Automatically track credits from approved CLE providers</p>
