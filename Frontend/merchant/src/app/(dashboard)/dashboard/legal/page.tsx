/**
 * Legal Services Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/legal", icon: Home, active: true },
  { label: "Cases", href: "/dashboard/legal/cases", icon: Briefcase },
  { label: "Clients", href: "/dashboard/legal/clients", icon: Users },
  { label: "Documents", href: "/dashboard/legal/documents", icon: FileText },
  
  // INDUSTRY-SPECIFIC
  { label: "Billable Hours", href: "/dashboard/legal/time", icon: Clock },
  { label: "Court Dates", href: "/dashboard/legal/court-dates", icon: Calendar },
  { label: "Invoices", href: "/dashboard/legal/invoices", icon: DollarSign },
  { label: "Staff", href: "/dashboard/legal/staff", icon: Users },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/legal/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/legal/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/legal/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/legal/settings", icon: Settings },
];

export default function LegalServicesDashboardHub() {
  return (
    <ErrorBoundary componentName="Legal Services Dashboard Hub">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-50">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <Breadcrumbs
            items={[
              { label: "Dashboard", href: "/dashboard" },
              { label: "Legal Services", href: "/dashboard/legal" },
            ]}
          />
        </div>
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Case management, billable hours, and client representation
              </p>
            </div>
