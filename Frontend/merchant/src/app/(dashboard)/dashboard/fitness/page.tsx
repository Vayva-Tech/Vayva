/**
 * Fitness Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/fitness", icon: Home, active: true },
  { label: "Members", href: "/dashboard/fitness/members", icon: Users },
  { label: "Class Schedule", href: "/dashboard/fitness/classes", icon: Calendar },
  { label: "Trainers", href: "/dashboard/fitness/trainers", icon: Users },
  
  // INDUSTRY-SPECIFIC
  { label: "Workouts", href: "/dashboard/fitness/workouts", icon: Dumbbell },
  { label: "Memberships", href: "/dashboard/fitness/memberships", icon: CreditCard },
  { label: "Progress Tracking", href: "/dashboard/fitness/progress", icon: Heart },
  { label: "Challenges", href: "/dashboard/fitness/challenges", icon: Trophy },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/fitness/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/fitness/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/fitness/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/fitness/settings", icon: Settings },
];

export default function FitnessDashboardHub() {
  return (
    <ErrorBoundary componentName="Fitness Dashboard Hub">
          ...
          <aside className="w-64 bg-white border-r border-gray-200 min-h-screen p-4 fixed left-0 top-[73px] overflow-y-auto">
            <nav className="space-y-1">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <a
                  href="/dashboard/fitness/trainers"
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Member management, classes, and gym performance
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <MetricCard
                ...
                change={5}
                trend="up"
                icon={<Dumbbell size={16} className="text-orange-600" />}
              />
            </div>
