/**
 * Real Estate Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/real-estate", icon: HomeIcon, active: true },
  { label: "Listings", href: "/dashboard/real-estate/listings", icon: Home },
  { label: "Properties", href: "/dashboard/real-estate/properties", icon: MapPin },
  { label: "Clients", href: "/dashboard/real-estate/clients", icon: Users },
  
  // INDUSTRY-SPECIFIC
  { label: "Showings", href: "/dashboard/real-estate/showings", icon: Calendar },
  { label: "Offers", href: "/dashboard/real-estate/offers", icon: Key },
  { label: "Virtual Tours", href: "/dashboard/real-estate/tours", icon: Home },
  { label: "Agents", href: "/dashboard/real-estate/agents", icon: Users },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/real-estate/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/real-estate/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/real-estate/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/real-estate/settings", icon: Settings },
];

export default function RealEstateDashboardHub() {
  return (
    <ErrorBoundary componentName="Real Estate Dashboard Hub">
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <Breadcrumbs
            items={[
              { label: "Dashboard", href: "/dashboard" },
              { label: "Real Estate", href: "/dashboard/real-estate" },
            ]}
          />
        </div>
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Property listings, showings, and sales tracking
              </p>
            </div>
