/**
 * Nonprofit Dashboard Hub - Main Page
 */
...
const sidebarNavItems = [
  // CORE OPERATIONS
  { label: "Dashboard", href: "/dashboard/nonprofit", icon: Home, active: true },
  { label: "Donors", href: "/dashboard/nonprofit/donors", icon: Users },
  { label: "Campaigns", href: "/dashboard/nonprofit/campaigns", icon: Target },
  { label: "Events", href: "/dashboard/nonprofit/events", icon: Calendar },
  
  // INDUSTRY-SPECIFIC
  { label: "Donations", href: "/dashboard/nonprofit/donations", icon: HandHeart },
  { label: "Grants", href: "/dashboard/nonprofit/grants", icon: DollarSign },
  { label: "Volunteers", href: "/dashboard/nonprofit/volunteers", icon: Heart },
  { label: "Staff", href: "/dashboard/nonprofit/staff", icon: Users },
  
  // BUSINESS MANAGEMENT
  { label: "Finance", href: "/dashboard/nonprofit/finance", icon: DollarSign },
  { label: "Marketing", href: "/dashboard/nonprofit/marketing", icon: Megaphone },
  { label: "Analytics", href: "/dashboard/nonprofit/analytics", icon: BarChart3 },
  { label: "Settings", href: "/dashboard/nonprofit/settings", icon: Settings },
];

export default function NonprofitDashboardHub() {
  return (
    <ErrorBoundary componentName="Nonprofit Dashboard Hub">
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <Breadcrumbs
            items={[
              { label: "Dashboard", href: "/dashboard" },
              { label: "Nonprofit", href: "/dashboard/nonprofit" },
            ]}
          />
        </div>
          ...
          <aside className="w-64 bg-white border-r border-gray-200 min-h-screen p-4 fixed left-0 top-[73px] overflow-y-auto">
            <nav className="space-y-1">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <a
                  href="/dashboard/nonprofit/staff"
          ...
          <main className="ml-64 flex-1 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Donor management, campaigns, and fundraising
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <MetricCard
                ...
                change={22}
                trend="up"
                icon={<HandHeart size={16} className="text-emerald-600" />}
              />
              <MetricCard
