...
export default function AuthError({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-transparent">
      <div className="max-w-md w-full bg-white rounded-lg border border-gray-100 p-8 shadow-sm text-center">
        ...
        <div className="flex flex-col gap-3">
          <Button
            onClick={() => reset()}
            className="bg-green-500 hover:bg-green-500 text-white py-3 font-semibold"
          >
            Try again
          </Button>
          <Button
            ...
            className="border-gray-100 py-3 font-semibold"
          >
            Go back home
          </Button>
        </div>
