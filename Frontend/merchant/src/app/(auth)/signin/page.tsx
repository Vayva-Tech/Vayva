  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await AuthService.login({
        email,
        password,
        otpMethod: "EMAIL", // Default - user can change on verify page
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            >
              <input
                ...
                className="h-4 w-4 rounded border-gray-100 text-green-500 focus:ring-green-500 focus:ring-offset-0"
              />
