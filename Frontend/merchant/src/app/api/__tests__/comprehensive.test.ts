...
describe("Product API", () => {
  describe("POST /api/products/create", () => {
    it("should validate product data", async () => {
      ...
      const request = createMockRequest("POST", "/api/products/create", {
  ...
  describe("PATCH /api/products/[id]", () => {
    it("should update product successfully", async () => {
      ...
      const request = createMockRequest("PATCH", "/api/products/123", {
        name: "Updated Name",
        price: 39.99,
      }, { id: "123" });
    ...
    it("should return 404 for non-existent product", async () => {
      ...
      const request = createMockRequest("PATCH", "/api/products/nonexistent", {
        name: "Updated",
      }, { id: "nonexistent" });
...
describe("Payment API", () => {
  describe("POST /api/payments/initialize", () => {
    it("should validate payment amount", async () => {
      ...
      const request = createMockRequest("POST", "/api/payments/initialize", {
...
describe("Customer API", () => {
  describe("GET /api/customers", () => {
    it("should return list of customers", async () => {
      ...
      const request = createMockRequest("GET", "/api/customers");
    ...
    it("should support pagination", async () => {
      ...
      const request = createMockRequest("GET", "/api/customers?page=1&limit=10");
