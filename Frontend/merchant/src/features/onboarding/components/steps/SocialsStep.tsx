  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Instagram Card */}
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6 hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
          ...
          {ig?.connected ? (
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-2 text-sm font-bold text-green-600 bg-green-50/50 border border-green-100 px-4 py-3 rounded-2xl">
                <CheckCircle size={18} />
            ...
            >
              <Button
                className="w-full h-14 bg-green-500 hover:bg-green-600 text-white font-black text-lg rounded-2xl shadow-xl shadow-green/20 transition-all active:scale-[0.98]"
        ...
        {/* WhatsApp Card */}
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6 hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-green-500/10 to-green-500/10 rounded-bl-[100px] pointer-events-none" />

          <div className="flex items-start gap-4">
            <div className="bg-gradient-to-br from-green-500 to-green-600 p-3.5 rounded-2xl shadow-xl">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-green-50 border border-blue-100 rounded-2xl p-5 flex items-start gap-4">
        ...
        >
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-2xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-900">
                    <p className="font-semibold mb-2">How to Connect WhatsApp Business</p>
                    <ol className="space-y-2 list-decimal list-inside text-blue-700">
                      <li><strong>Install WhatsApp Business</strong> on your phone (free from App Store/Play Store)</li>
                      <li><strong>Click "Generate QR Code"</strong> button below</li>
                      <li><strong>Open WhatsApp Business</strong> on your phone</li>
                      <li><strong>Go to Settings → Linked Devices</strong></li>
                      <li><strong>Tap "Link a Device"</strong> and scan the QR code above</li>
                      <li><strong>Done!</strong> Your WhatsApp will be connected via Evolution API</li>
                    </ol>
                    <p className="mt-3 font-semibold text-blue-800">What happens next:</p>
                    <ul className="space-y-1 text-blue-700">
                      <li>✓ AI monitors customer messages 24/7</li>
                      <li>✓ Auto-replies to common inquiries</li>
                      <li>✓ Helps close sales while you sleep</li>
                      <li>✓ You can take over anytime</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              {/* QR Code */}
              <div className="bg-gradient-to-br from-white to-gray-50 border-2 border-gray-100 rounded-2xl p-8">
                <div className="flex flex-col items-center justify-center space-y-4">
                  <div className="w-64 h-64 bg-white/40 rounded-2xl flex items-center justify-center border-2 border-dashed border-gray-100">
                    {waQr ? (
                      <img
                        src={waQr}
              ...
              <div className="flex gap-3 pt-4 border-t-2 border-gray-100">
                ...
                <Button
                  className="flex-1 h-12 bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl shadow-lg"
                  onClick={() => setShowWhatsAppSetup(false)}
                >
                  Done
                </Button>
