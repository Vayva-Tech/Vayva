...
export default function IndustryStep() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Industry Grid - Categorized by Design Style */}
      <div className="space-y-8 mb-6">
        {/* Signature Category (Default) */}
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
            <Sparkle size={20} className="text-vayva-green" />
            Most Popular Industries
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {industries
              .filter(ind => ind.designCategory === "signature")
              .map((industry) => {
        ...
        {/* Other Industries - Accordion Style */}
        <div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`
                        ...
                        ${isSelected ? "bg-green-500 text-white" : "bg-gray-50 text-gray-500"}
                      `}>
                      ...
                      {isSelected && (
                        <CheckCircle size={16} className="text-green-500 flex-shrink-0 ml-auto" weight="fill" />
                      )}
                    </div>
                  </Button>
                );
