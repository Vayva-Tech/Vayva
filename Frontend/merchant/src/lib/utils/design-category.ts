...
export function getLabelTextClasses(category: DesignCategory): string {
  switch (category) {
    ...
    case "natural":
      return "text-orange-700 text-sm font-medium";
    case "signature":
    default:
      return "text-gray-600 text-sm font-medium";
  }
...
export function getTrendClasses(category: DesignCategory): string {
  switch (category) {
    ...
    case "dark":
      return "text-green-600 bg-green-50 px-2 py-1 rounded-full text-xs font-semibold";
    case "bold":
      return "text-green-700 bg-green-100 px-2 py-1 rounded font-bold text-xs";
    case "natural":
...
export function getTaskItemClasses(category: DesignCategory, isCompleted: boolean): string {
  ...
  if (isCompleted) {
    switch (category) {
      ...
      case "bold":
        return `${baseClasses} bg-green-100 border-2 border-green-300`;
      case "natural":
        return `${baseClasses} bg-green-50/50 border border-green-200/30`;
      case "signature":
      default:
    ...
    switch (category) {
      case "glass":
        return `${baseClasses} bg-white border border-gray-100 hover:bg-gray-50`;
      case "dark":
        return `${baseClasses} bg-white border border-gray-100 hover:bg-gray-50`;
      case "bold":
        return `${baseClasses} bg-white border border-gray-300 hover:border-gray-400 hover:-translate-y-0.5`;
      case "natural":
        return `${baseClasses} bg-orange-50/60 border border-amber-200/50 hover:bg-orange-100/60`;
      case "signature":
      default:
...
export function getPriorityBadgeClasses(category: DesignCategory, priority: 'high' | 'medium' | 'low'): string {
  const priorityColors = {
    high: {
      ...
      dark: "bg-red-100 text-red-700 border-red-200",
    ...
    medium: {
      glass: "bg-orange-100 text-orange-700 border-amber-200",
      dark: "bg-orange-100 text-orange-700 border-amber-200",
      bold: "bg-orange-500 text-white border-amber-600",
      natural: "bg-orange-100 text-orange-700 border-amber-200",
      signature: "bg-orange-100 text-orange-700 border-amber-200"
    },
    low: {
      glass: "bg-blue-100 text-blue-700 border-blue-200",
      dark: "bg-blue-100 text-blue-700 border-blue-200",
