...
export const PERMISSIONS = {
  ...
  FINANCE_INSTANT_WITHDRAW: "finance:instant-withdraw",
...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      {
        id: PERMISSIONS.FINANCE_VIEW,
        label: "View Finance Dashboard",
        description: "Access finance hub and view transactions",
      },
      {
        id: PERMISSIONS.PAYOUTS_VIEW,
        label: "View Payouts",
        description: "See payout history and status",
      },
      {
        id: PERMISSIONS.FINANCE_WITHDRAW,
        label: "Request Withdrawals",
        description: "Initiate standard withdrawals (3-5 days)",
      },
      {
        id: PERMISSIONS.FINANCE_INSTANT_WITHDRAW,
        label: "Instant Withdrawals",
        description: "⚡ SENSITIVE: Instant Paystack transfers (30 seconds)",
      },
      {
      ...
      },
      {
        ...
        description: "SENSITIVE: Final approval on large refunds",
      },
      {
...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.FINANCE]: [
    ...
    PERMISSIONS.FINANCE_INSTANT_WITHDRAW,
    PERMISSIONS.PAYOUTS_MANAGE,
    PERMISSIONS.PAYOUTS_VIEW,
    PERMISSIONS.REFUNDS_MANAGE,
    PERMISSIONS.SETTINGS_VIEW,
