...
export function applyDesignCategory(category: DesignCategory): void {
  ...
  switch (category) {
    ...
    case "dark":
      root.style.setProperty("--bg-green-500", "#0D0D0D");
      root.style.setProperty("--text-green-500", "#E5E7EB");
    ...
    case "signature":
    default:
      root.style.setProperty("--bg-green-500", "#F9FAFB");
      root.style.setProperty("--text-green-500", "#1F2937");
...
export function resetToDefaultTheme(): void {
  ...
  root.style.removeProperty("--bg-green-500");
  root.style.removeProperty("--text-green-500");
...
export function getDesignCategoryClasses(category: DesignCategory): string {
  switch (category) {
    case "glass":
      return "bg-gradient-to-br from-pink-50 via-purple-50 to-red-50";
    case "dark":
