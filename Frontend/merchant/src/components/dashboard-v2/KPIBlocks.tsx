    ...
    <Card className="p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          {loading ? (
            <div className="h-8 w-32 bg-white-2/50 rounded-xl animate-pulse" />
          ) : (
    ...
    <section aria-label="Key Performance Indicators" className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-500 hover:text-gray-900 hover:bg-white-2/50 rounded-xl h-auto"
