...
export function AutopilotBanner() {
  ...
  if (loading) {
    return (
      <div 
        className="relative rounded-2xl border border-gray-100 bg-gray-50  p-4 flex items-center gap-4 overflow-hidden"
        role="region"
        aria-label="Autopilot suggestions loading"
      >
        <div className="p-2 rounded-xl bg-white-2/50 shrink-0">
          <div className="w-[18px] h-[18px] bg-white-2/50 rounded animate-pulse" />
        </div>
        <div className="flex-1 space-y-2">
          <div className="h-4 w-20 bg-white-2/50 rounded animate-pulse" />
          <div className="h-3 w-3/4 bg-white-2/30 rounded animate-pulse" />
        </div>
        <div className="h-8 w-20 bg-white-2/50 rounded-xl animate-pulse shrink-0" />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div 
        className="relative rounded-2xl border border-status-danger/20 bg-status-danger/5  p-4 flex items-center gap-4"
        role="alert"
        aria-live="polite"
      >
  ...
  return (
    <div 
      className="relative rounded-2xl border border-green-500/20 bg-green-500/[0.03]  p-4 flex items-center gap-4 overflow-hidden group"
      role="region"
      aria-label="Autopilot suggestions"
    >
      <div className="p-2 rounded-xl bg-green-500/10 text-green-500 shrink-0" aria-hidden="true">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Button
          ...
          className="h-7 w-7 rounded-lg text-gray-400 hover:text-gray-500 hover:bg-white-2/50"
