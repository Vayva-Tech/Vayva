      ...
      <SectionShell title={`${label} Health`} icon="Activity">
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-12 rounded-2xl bg-white-2/50 animate-pulse"
            />
          ))}
        </div>
      </SectionShell>
      ...
      <SectionShell title={title} icon="Radio">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-20 rounded-2xl bg-white-2/50 animate-pulse"
            />
          ))}
        </div>
      </SectionShell>
          ...
          return (
            ...
            >
              <Icon
                ...
                className={cn(
                  "mx-auto mb-2",
                  isCritical ? "text-status-danger" : "text-gray-400",
                )}
              />
              <div
                className={cn(
                  "text-2xl font-bold",
                  isCritical ? "text-status-danger" : "text-gray-900",
                )}
              >
                {isEmpty ? "—" : item.value}
              </div>
      ...
      <SectionShell title="Bottlenecks & Alerts" icon="ShieldAlert">
        <div className="space-y-2">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="h-14 rounded-2xl bg-white-2/50 animate-pulse"
            />
          ))}
        </div>
      </SectionShell>
      ...
      <SectionShell title="Suggested Actions" icon="Lightbulb">
        <div className="space-y-2">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="h-16 rounded-2xl bg-white-2/50 animate-pulse"
            />
          ))}
        </div>
      </SectionShell>
      ...
      <div className="space-y-2">
        {actions.map((action) => {
          ...
          return (
            ...
            >
              <div className="h-10 w-10 rounded-2xl bg-white-2/50 flex items-center justify-center shrink-0">
                <Icon
