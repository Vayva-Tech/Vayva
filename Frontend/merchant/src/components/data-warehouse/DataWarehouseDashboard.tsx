        ...
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full min-h-[200px] p-4 border border-gray-100 rounded-lg bg-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-green-500 resize-none"
              onKeyDown={(e) => {
          ...
          <div className="space-y-3">
            {history.slice(0, 5).map((item: QueryHistory) => {
              ...
              return (
                <div 
                  key={item.id}
                  className="p-3 border border-gray-100 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer"
      ...
      <ThemedCard industry={store?.industrySlug || 'default'}>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">94% of pipelines running successfully</p>
          </div>
