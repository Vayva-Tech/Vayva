    ...
    <div className="flex flex-col h-[calc(100vh-100px)] relative">
      ...
      <div className="flex-1 w-full flex gap-6 overflow-hidden">
        <div className="flex-1 flex flex-col">
          ...
          <Textarea
            className="flex-1 w-full p-6 border border-gray-100 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-black/5 font-mono text-sm leading-relaxed"
            value={content}
        ...
        <div className="hidden lg:flex flex-1 flex-col bg-white/40 rounded-xl border border-gray-100 p-6 overflow-y-auto">
      ...
      {/* Sticky Bottom Bar */}
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 flex items-center justify-end gap-3 rounded-b-xl">
        {isDirty && (
        ...
        <Button
          ...
          className="bg-black text-white hover:bg-text-green-500"
        >
          {isSaving ? (
