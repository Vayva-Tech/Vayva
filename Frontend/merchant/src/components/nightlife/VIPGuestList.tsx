  ...
  return (
    <Card className="p-6 bg-[#252525] border-[#333333]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-bold text-lg text-gray-900">VIP Guest List</h3>
      ...
      {stats && (
        <div className="mt-4 pt-4 border-t border-[#333333] text-xs text-gray-500 flex items-center justify-between">
