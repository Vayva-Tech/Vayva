...
export function KYCVerification({ onSuccess, onCancel }: KYCVerificationProps) {
      ...
      <div className="py-10 px-6 space-y-6">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <div className="rounded-xl border border-white/10 bg-white p-4">
            <p className="text-xs uppercase tracking-wider text-gray-400">Previous NIN</p>
            <p className="text-sm font-semibold text-white">
              {kycStatus.ninSubmitted ? "Submitted" : "Not provided"}
            </p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white p-4">
            <p className="text-xs uppercase tracking-wider text-gray-400">Previous CAC</p>
            <p className="text-sm font-semibold text-white">
        ...
        <div className="p-4 bg-orange-500/5 rounded-xl border border-amber-500/20">
  ...
  if (kycStatus?.status?.toUpperCase() === "PENDING") {
    return (
      <div className="py-10 px-6 space-y-6">
        <div className="flex items-start gap-4 rounded-2xl border border-amber-500/30 bg-orange-500/10 p-5">
  ...
  return (
    <div className="max-w-md mx-auto space-y-6 p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-white/10">
          <Input type="checkbox"
            checked={consent}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
