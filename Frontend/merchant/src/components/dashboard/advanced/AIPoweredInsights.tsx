        ...
        <div className="space-y-4">
          {insights.map((insight) => {
            ...
            return (
              <div 
                key={insight.id}
                className="p-4 rounded-xl border border-gray-100 hover:border-gray-100 transition-colors group"
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-1 text-xs">
                      ...
                      <span className="font-medium text-gray-900">{insight.impactScore}/100</span>
                    </div>
                  </div>
