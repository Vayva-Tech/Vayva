    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {students.slice(0, 8).map((student) => (
          <Card key={student.studentId} className={`border-gray-100 hover:border-green-500/50 transition-all rounded-2xl ${student.atRiskReasons ? 'border-red-500/50 bg-red-950/20' : ''}`}>
            <CardContent className="p-4">
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {student.courses.slice(0, 3).map((course) => (
                    <div key={course.courseId} className="text-xs px-3 py-1.5 rounded-full bg-gray-100/50">
