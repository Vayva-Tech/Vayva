        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="text-sm text-gray-500">
              <span className="font-medium text-gray-900">Recommendation:</span> Schedule success calls, offer training sessions
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="px-3 py-1 bg-green-50 rounded-full text-xs font-medium text-green-600">
