      ...
      {orderId && (
        <div className="bg-green-50 rounded-xl p-3 mb-3 border border-green-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-green-600 font-medium">Live Tracking Dashboard</p>
              <p className="text-xs text-green-500">View real-time rider location</p>
            </div>
            <a
              href={liveTrackingLink}
              className="text-xs bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded-lg font-medium flex items-center gap-1"
            >
