...
export const BankCard = ({ account }: BankCardProps) => {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col h-full relative overflow-hidden hover:border-gray-100 transition-colors">
      ...
      <div className="flex-1">
        {account ? (
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-4 text-white shadow-xl relative overflow-hidden">
            ...
            <p className="font-mono text-gray-400 tracking-wider text-sm mb-4">
          ...
          <div className="bg-orange-50 rounded-xl p-4 border border-amber-100 text-sm">
      ...
      <div className="mt-6">
        <Button variant="outline" className="w-full gap-2 text-gray-500">
