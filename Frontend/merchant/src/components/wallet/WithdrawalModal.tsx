...
import { Button, Icon, Input, Modal, cn } from "@vayva/ui";
      ...
      <div className="space-y-6">
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            {eligibility && (
              <>
                <div className="p-4 bg-white/40 rounded-xl border border-gray-100 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="number"
                  ...
                  disabled={loading}
                  className="w-full pl-10 pr-4 py-3 border border-gray-100 rounded-xl font-mono text-lg font-bold focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-shadow"
                  placeholder="0.00"
                />
              </div>
        ...
        {step === 3 && quote && (
          <div className="space-y-6">
            <div className="bg-white/40 border border-gray-100 rounded-xl p-5 space-y-3">
