...
export default function WalletGuard({ children }: WalletGuardProps) {
  ...
  return (
    <>
      ...
      />
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 bg-white/30 rounded-2xl border border-gray-100">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-sm w-full text-center space-y-6">
          ...
          <div className="text-center">
            <Button
              ...
              className="text-xs text-gray-400 font-normal hover:text-gray-500"
            >
