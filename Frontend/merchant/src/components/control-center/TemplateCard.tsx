    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1">
          ...
          {isLocked && (
            <span className="bg-text-green-500/90 text-white text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wide shadow-sm flex items-center gap-1">
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 backdrop-blur-[2px]">
          <Button
            ...
            variant="ghost"
            className="bg-white text-black px-4 py-2 rounded-xl text-xs font-bold shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 hover:bg-white/40 flex items-center gap-2"
          >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {template.tags.slice(0, 3).map((tag: string) => (
            <span
              key={tag}
              className="text-[10px] bg-white/40 text-gray-400 px-2 py-1 rounded-md border border-gray-100 font-medium"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 space-y-3">
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-400 font-medium capitalize flex items-center gap-1">
          ...
          {template.isActive ? (
            <Button
              className="w-full py-2.5 bg-white/40 text-gray-400 rounded-xl text-sm font-bold cursor-default flex items-center justify-center gap-2"
              variant="ghost"
            >
            ...
            <Button
              ...
              variant="primary"
              className="w-full py-2.5 bg-text-green-500 text-white rounded-xl text-sm font-bold hover:bg-text-green-500 transition-colors flex items-center justify-center gap-2"
            >
            ...
            <Button
              ...
              variant="primary"
              className="w-full py-2.5 bg-black text-white rounded-xl text-sm font-bold hover:bg-text-green-500 transition-colors shadow-sm group-hover:shadow-md flex items-center justify-center gap-2"
            >
            ...
            <Button
              onClick={() => onUse(template)}
              variant="primary"
              className="w-full py-2.5 bg-black text-white rounded-xl text-sm font-bold hover:bg-text-green-500 transition-colors shadow-sm group-hover:shadow-md"
            >
              Use Template
            </Button>
          )}
