...
export const TemplatePreview = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70  flex flex-col animate-in fade-in duration-200">
      {/* Top Bar */}
      <div className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6 shadow-sm z-10">
        ...
        <div className="flex items-center gap-3">
          {isLocked ? (
            <div className="flex items-center gap-2 text-sm font-bold text-gray-400 bg-white/40 px-3 py-1.5 rounded-lg">
      ...
      <div className="flex-1 bg-white/40 overflow-hidden flex items-center justify-center relative">
        ...
        <div
          className={cn(
            ...
            viewMode === "mobile"
              ? "w-[375px] h-[812px] rounded-[40px] border-[8px] border-gray-100"
              : "w-full h-full",
          )}
        >
          <iframe
