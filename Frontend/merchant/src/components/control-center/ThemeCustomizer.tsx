...
export const ThemeCustomizer = ({
  ...
  return (
    <div className="w-80 border-r border-gray-100 h-full overflow-y-auto bg-white flex flex-col">
            ...
            <div key={field.id} className="space-y-2">
              ...
              {field.type === "text" && (
                <Input type="text"
                  ...
                  className="w-full text-sm border border-gray-100 rounded-lg px-3 py-2 focus:ring-1 focus:ring-black outline-none"
                  title={field.label}
                />
              )}
                      ...
                      >
                        {(provided: DraggableProvided) => (
                          <div
                            ...
                            className="bg-white border border-gray-100 rounded-xl p-3 flex items-center gap-3 shadow-sm hover:border-black transition-colors"
                          >
                            <Icon
                              name="GripVertical"
                              size={14}
