...
export function TaskManagement({ data }: TaskManagementProps) {
  ...
  return (
    <Card className="p-6 border-l-4 border-teal-700 shadow-lg  bg-white/90">
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        ...
        <div className="text-center p-3 bg-orange-50 rounded-lg">
          <div className="text-2xl font-bold text-orange-700">{data.dueToday}</div>
          <div className="text-xs text-orange-700">Due Today</div>
        </div>
      ...
      <div className="space-y-2 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-medium text-gray-900">{data.byRole.attorneys}</span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-500">Paralegals</span>
          <span className="font-medium text-gray-900">{data.byRole.paralegals}</span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-500">Staff</span>
          <span className="font-medium text-gray-900">{data.byRole.staff}</span>
        </div>
