  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-gray-900">Size Chart</h3>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {measurements.map((m) => (
          <div
            key={m}
            className="flex items-center gap-1 px-2 py-1 bg-gray-50 rounded border border-gray-100 text-sm"
          >
        ...
        <div className="border border-gray-100 rounded-lg overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                <th className="p-2 text-left font-medium text-gray-500">Size</th>
                {measurements.map((m) => (
                  <th key={m} className="p-2 text-left font-medium text-gray-500">
                    {formatLabel(m)} (in/cm)
                  </th>
                ))}
