...
export const DesignerDashboard = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default:
        return "bg-white/40 text-gray-400";
    }
  };
    ...
    <div className="max-w-7xl mx-auto p-8">
      <header className="flex justify-between items-center mb-12">
        ...
        <Button
          ...
          className="bg-black text-white px-6 py-3 rounded-xl font-bold hover:bg-text-green-500 transition-colors shadow-lg flex items-center gap-2 h-auto"
        >
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white/40 rounded-2xl border border-dashed border-gray-100">
          ...
          <Button
            variant="outline"
            className="bg-white border border-gray-100 text-black px-4 py-2 rounded-lg font-bold text-sm h-auto"
          >
            Read Guidelines
          </Button>
        </div>
        ...
        <div className="space-y-4">
          {templates.map((tpl) => (
            <div
              key={tpl.id}
              className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:shadow-md transition-shadow"
            >
              ...
              <div className="flex items-center gap-6 min-w-[200px] justify-end">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="p-2 hover:bg-white/40 rounded-lg text-gray-400 hover:text-black transition-colors h-auto w-auto"
                >
