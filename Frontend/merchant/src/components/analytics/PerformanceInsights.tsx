...
export const PerformanceInsights = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Recommendation */}
      {recommendation && (
        <div className="bg-gradient-to-br from-green-50 to-purple-50 border border-green-100 rounded-xl p-5 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-4 opacity-10">
            <Icon name="Sparkles" size={64} className="text-green-500" />
          </div>

          <h4 className="text-sm font-bold text-green-900 mb-2 flex items-center gap-2">
            <Icon name="Sparkles" size={14} className="text-green-500" /> AI
            Recommendation
          </h4>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              size="sm"
              className="bg-green-600 text-white hover:bg-green-700 shadow-sm transition-colors text-xs font-bold"
            >
              Preview Template
            </Button>
          </div>
