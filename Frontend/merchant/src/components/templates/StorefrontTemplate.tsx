    ...
    >
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-12 md:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          >
            ...
            <span className={cn(isDark ? "text-white/60" : "text-gray-500")}>
              2026 Collection
            </span>
          </div>
              ...
              >
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isDark ? "border-white/20 text-white" : "border-gray-300",
                  )}
                >
                  Add to cart
                </Button>
      ...
      {sections.includes("cta") && (
        <section className="mx-auto max-w-6xl px-6 pb-16">
          <div
            className={cn(
              "rounded-2xl p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4",
              isDark ? "bg-white/10" : "bg-gray-100",
            )}
          >
            <div>
