...
export function TemplateCard({
    ...
    const industryStyles: Record<string, { bg: string; text: string; border: string }> = {
        ...
        realestate: { bg: "bg-green-50", text: "text-green-700", border: "border-green-200" },
        services: { bg: "bg-cyan-50", text: "text-cyan-700", border: "border-cyan-200" },
        events: { bg: "bg-red-50", text: "text-red-700", border: "border-red-200" },
        ...
        nonprofit: { bg: "bg-orange-50", text: "text-orange-700", border: "border-amber-200" },
