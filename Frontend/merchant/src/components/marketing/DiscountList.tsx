...
export function DiscountList() {
  ...
  if (error)
    return (
      <div className="text-red-500" aria-live="assertive" role="alert">
        Failed to load discounts
      </div>
    );
  if (!discounts)
    return (
      <div className="p-8 text-center text-gray-400" aria-live="polite" role="status">
        Loading...
      </div>
    );
                ...
                <TableCell>
                  ...
                  {d.code && (
                    <div className="flex items-center gap-1 text-xs text-green-500 mt-1">
                      <Tag size={12} />
                      <span className="font-mono bg-green-500/10 px-1 rounded">
                        {d.code}
                      </span>
                    </div>
                  )}
