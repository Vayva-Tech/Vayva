      ...
      {!summaryLoading && summary && (
        ...
        >
          ...
          <ThemedCard industry={store?.industrySlug || 'default'}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">High Risk Churn</p>
          ...
          <ThemedCard industry={store?.industrySlug || 'default'}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Avg LTV Growth</p>
        ...
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="space-y-4">
            <div className="p-3 bg-blue-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500">Periods showing growth</p>
            </div>
            ...
            <div className="p-3 bg-yellow-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500">Consistent demand patterns</p>
            </div>
            ...
            <div className="p-3 bg-red-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500">Periods showing decline</p>
            </div>
          </div>
        </ThemedCard>
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {prediction.retentionActions.slice(0, 2).map((action, idx) => (
                    <span key={idx} className="text-xs px-2 py-1 bg-green-500/10 text-green-500 rounded-full">
                      {action}
                    </span>
                  ))}
                </div>
          ...
          <ThemedCard industry={store?.industrySlug || 'default'}>
            ...
            <div className="space-y-3 mb-4">
              <div className="flex justify-between">
                <span className="text-sm text-gray-500">Current LTV</span>
                <span className="font-medium">₦{prediction.currentLTV?.toLocaleString() || '0'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-500">Predicted LTV</span>
