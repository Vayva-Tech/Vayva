  ...
  return (
    <div className="space-y-2 mt-2">
      <div className="flex items-center gap-2">
        <div className="flex-1 h-1.5 bg-white-2/50 rounded-full overflow-hidden">
          <div
            className={cn(
          ...
          return (
            <li
              ...
              className={cn(
                ...
                isMet ? "text-status-success" : "text-gray-400",
              )}
            >
              <span
                className={cn(
                  "w-3.5 h-3.5 rounded-full flex items-center justify-center text-[10px]",
                  isMet ? "bg-status-success text-white" : "bg-white-2/50",
                )}
              >
                {isMet && "✓"}
              </span>
