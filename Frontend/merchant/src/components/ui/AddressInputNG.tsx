    ...
    <div className="space-y-4">
      <div>
        ...
        <Input value={value?.addressLine1 || ""}
          ...
          className="w-full border border-gray-100 bg-white px-4 h-12 rounded-xl text-sm focus:outline-none focus:border-vayva-green focus:ring-2 focus:ring-vayva-green/20"
