...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("rounded-[28px] border border-border/60 bg-background/70 backdrop-blur-xl shadow-card", className), ...props })));
