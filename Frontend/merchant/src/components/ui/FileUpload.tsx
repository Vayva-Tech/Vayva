...
export function FileUpload({
  ...
  if (value) {
    return (
      <div className="relative border rounded-lg p-4 flex items-center gap-3 bg-white-2/50">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium truncate text-green-500 hover:underline">
  ...
  return (
    <div className="w-full">
      <label className={cn(
        "border-2 border-dashed border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center bg-white-2/50 transition-colors gap-2 text-center relative",
        disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:bg-white-2/50"
      )}>
        {uploading ? (
          <>
