...
export function ProductsTable({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl shadow-black/5 border border-studio-border overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
      <table className="w-full text-left text-sm">
        <thead className="bg-studio-gray text-gray-400 font-bold border-b border-studio-border uppercase tracking-widest text-[10px]">
          <tr>
      ...
      {nextCursor && (
        <div className="p-4 bg-white/30 border-t border-gray-100 flex justify-center">
          <Button
            variant="outline"
