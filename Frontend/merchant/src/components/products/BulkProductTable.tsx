...
import { Spinner as Loader2, Check, X } from "@phosphor-icons/react/ssr";
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <table className="w-full text-left text-sm">
          <thead className="bg-white/40 text-gray-400 font-medium border-b border-gray-100">
            <tr>
                ...
                >
                  <td className="px-6 py-3">
                    <Input
                      ...
                      className="h-8 bg-transparent border-transparent hover:border-gray-100 focus:bg-white"
                    />
                  </td>
                  <td className="px-6 py-3">
                    <Input
                  ...
                  <td className="px-6 py-3 text-gray-400">{p.currency}</td>
                </tr>
              );
            })}
          </tbody>
