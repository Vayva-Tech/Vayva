    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[40%] relative bg-[#020817] flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute -top-[20%] -right-[20%] w-[80%] h-[80%] rounded-full bg-green-500 opacity-20 blur-[120px]" />
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-center px-12">
          <div className="bg-white  border border-white/10 rounded-[32px] p-10 shadow-2xl">
            <div className="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center mb-8 text-green-500">
            ...
            <p className="text-lg text-gray-400 leading-relaxed mb-8">
              Transform chaotic conversations into organized orders, payments,
              and delivery tracking. The operating system for modern African
              commerce.
            </p>
            ...
            <div className="flex items-center gap-6 text-sm font-medium text-gray-400">
              ...
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-white/400" />
                Automated Invoices
              </div>
            </div>
          </div>
        ...
        {/* Sidebar Footer */}
        <div className="relative z-20 p-8 text-xs text-gray-500">
          © 2026 Vayva Inc.
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-[440px] space-y-8">{children}</div>
        </div>
