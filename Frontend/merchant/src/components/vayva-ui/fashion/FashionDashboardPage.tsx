...
function FashionDashboardContent() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <header className="sticky top-0 z-50 bg-white/80  border-b border-white/40 shadow-sm">
      ...
      <main className="max-w-[1800px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <FashionKPICard
            ...
            gradient="from-green-500 via-green-500 to-teal-500"
          />
          ...
          <FashionKPICard
            ...
            gradient="from-pink-500 via-red-500 to-red-500"
          />
        </div>
