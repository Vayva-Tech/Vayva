...
export default function SimplifiedBusinessStep() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm space-y-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <div className="bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-3 text-sm font-bold text-gray-500 whitespace-nowrap">
              vayva.ng/
            </div>
            <div className="flex-1 relative">
              <Input
                ...
                className="h-12 rounded-xl border-2 border-gray-100 focus:border-vayva-green focus:ring-vayva-green/20 font-bold"
      ...
      <div className="pt-4">
        <Button
          className="w-full h-14 bg-vayva-green hover:bg-vayva-green/90 text-white rounded-2xl font-black text-lg shadow-xl shadow-green/20 transition-all active:scale-[0.98]"
