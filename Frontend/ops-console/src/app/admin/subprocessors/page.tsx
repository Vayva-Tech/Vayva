...
const initialSubprocessors = [
  ...
  },
  {
    ...
    purpose: 'Frontend hosting, preview deployments, edge functions',
    dataProcessed: 'HTTP requests, build logs, deployment metadata',
    location: 'Global edge (see Vercel trust documentation)',
    safeguards: 'SOC 2 Type II, GDPR-aligned DPA where applicable',
    website: 'https://vercel.com/security',
    dpaStatus: 'Vercel DPA as applicable',
    dateAdded: '2024-01-15',
    lastReviewed: '2026-03-01',
    status: 'active',
  },
  {
    id: '2b',
    name: 'Self-managed VPS & object storage',
    category: 'Cloud Infrastructure',
    purpose: 'PostgreSQL, Redis, APIs/workers, MinIO/S3-compatible storage, WhatsApp gateway (Evolution) where self-hosted',
    dataProcessed: 'Application and merchant data as deployed on Vayva-operated servers',
    location: 'Hosting provider facilities per deployment runbooks',
    safeguards: 'SSH keys, firewalls, TLS, encrypted volumes as implemented by operations',
    website: 'https://vayva.ng',
    dpaStatus: 'Operational controls (internal)',
