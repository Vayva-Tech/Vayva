      ...
      {predictions.map((model: PredictionModel, index: number) => (
        ...
        >
          <ThemedCard industry={store?.industrySlug || 'default'}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground capitalize">{model.type} prediction</p>
                </div>
              </div>
            ...
            <div className="h-48 bg-gradient-to-br from-muted/20 to-muted/5 rounded-xl border border-border mb-4 flex items-center justify-center">
              <div className="text-center">
                <ChartLine className="h-8 w-8 mx-auto mb-2 text-muted-foreground" />
                <p className="text-sm text-muted-foreground">Prediction trend visualization</p>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <p className="text-muted-foreground">Next Training</p>
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex flex-col items-end">
                ...
                {!anomaly.resolved && (
                  <button className="mt-2 px-3 py-1 bg-primary text-primary-foreground text-xs rounded-lg hover:opacity-90 transition-opacity">
                    Resolve
                  </button>
                )}
              </div>
