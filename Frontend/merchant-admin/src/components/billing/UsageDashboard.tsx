  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between text-xs">
        <span className="text-text-tertiary">{percentage}% used</span>
        {projectedOverLimit && (
      ...
      {overage > 0 && (
        <div className="flex items-center justify-between text-xs bg-destructive/5 rounded-lg px-3 py-2">
...
export function UsageDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold text-text-primary">Usage & Limits</h2>
      ...
      {/* Usage Stats */}
      <div className="rounded-[20px] border border-border/60 bg-background/70 backdrop-blur-xl p-6 space-y-6">
        {data.stats.map((stat) => (
          <UsageProgress
            key={stat.metric}
