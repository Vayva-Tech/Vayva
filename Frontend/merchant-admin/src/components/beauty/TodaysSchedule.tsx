    ...
    <Card className="glass-panel p-6 border border-white/10">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="ghost" size="sm" className="text-rose-400 hover:text-rose-300 text-xs">
            Manage Schedule
          </Button>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {apt.service && (
                        <p className="text-text-secondary text-xs">{apt.service}</p>
                      )}
                    </div>
                  </div>
                  {apt.customerName && (
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
            <div>
              <p className="text-text-secondary text-sm mb-1">Walk-ins Today:</p>
              <p className="text-white font-semibold">{walkins}</p>
            </div>
            <div>
              <p className="text-text-secondary text-sm mb-1">No-shows:</p>
              <p className="text-white font-semibold">{noShows}</p>
            </div>
            <div>
              <p className="text-text-secondary text-sm mb-1">Rebooked:</p>
