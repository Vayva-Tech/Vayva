        ...
        <>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-around py-4">
              <div className="text-center">
                ...
                <p className="text-text-secondary text-xs">New Clients</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{regularClients}%</p>
                <p className="text-text-secondary text-xs">Regular</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{vipClients}%</p>
                <p className="text-text-secondary text-xs">VIP</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-4 border-t border-white/10">
            <div className="flex items-center justify-between">
              <span className="text-text-secondary text-sm">Retention Rate:</span>
              <span className="text-emerald-400 font-semibold">{retentionRate}%</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-text-secondary text-sm">Avg Lifetime Value:</span>
