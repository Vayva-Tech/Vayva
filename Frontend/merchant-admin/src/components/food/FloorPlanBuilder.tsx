    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-text-primary">Floor Plan</h3>
        </div>
        <div className="flex items-center gap-2">
          <Input
            value={value.name}
      ...
      <div className="flex gap-4">
        ...
        <div
          ref={canvasRef}
          className="relative bg-muted rounded-lg border-2 border-border/40 overflow-hidden"
        ...
        <div className="w-64 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Select
                    ...
                    className="w-full h-8 mt-1 px-2 border border-border rounded text-sm bg-background"
                  >
                    {TABLE_TYPES.map((t) => (
          ...
          <div className="pt-4 border-t border-border/40 space-y-2">
            <h4 className="text-xs font-medium text-text-secondary">Status Legend</h4>
