  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <QrCodeIcon className="h-5 w-5 text-text-secondary" />
        <h3 className="font-semibold text-text-primary">QR Code Generator</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Preview */}
        <div className="flex flex-col items-center justify-center p-6 bg-muted rounded-lg border-2 border-dashed border-border/40">
          {generated && qrDataUrl ? (
