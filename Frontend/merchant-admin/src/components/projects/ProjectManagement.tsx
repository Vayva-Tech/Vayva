            ...
            <div className="flex items-center justify-between pt-3 border-t border-border">
              ...
              <div className="flex -space-x-2">
                {project.team.slice(0, 3).map((member: TeamMember) => (
                  <div key={member.id} className="w-6 h-6 bg-gradient-to-br from-primary/20 to-accent/20 rounded-full flex items-center justify-center border-2 border-background">
        ...
        >
          <ThemedCard industry={store?.industrySlug || 'default'}>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">{'Developer Designer Project Manager'.split(' ')[i % 3]}</p>
              ...
              <div className="mt-4 pt-4 border-t border-border">
                ...
                <p className="text-xs text-muted-foreground mt-1 text-center">Weekly Capacity</p>
              </div>
            </div>
          </ThemedCard>
        </motion.div>
