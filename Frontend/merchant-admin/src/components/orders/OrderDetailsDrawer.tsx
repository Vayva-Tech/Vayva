    ...
    if (showCancel) {
      return (
        <div className="flex flex-col gap-3 w-full animate-in slide-in-from-bottom-5">
          ...
          <Input className="w-full border border-border/60 rounded-xl p-2 text-sm bg-background/70 backdrop-blur-xl shadow-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-text-secondary">View rider location in real-time</p>
                    </div>
                  </div>
                  <Button
                    size="sm"
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-mono font-bold text-emerald-600">{shipment.trackingCode}</p>
                    </div>
                  </div>
                </div>
              </div>
