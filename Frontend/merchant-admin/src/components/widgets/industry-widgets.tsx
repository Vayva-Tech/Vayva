      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{optimization.displayName}</p>
          </div>
        </div>
        ...
        {data?.appointments?.slice(0, 4).map((apt: any, index: number) => (
          ...
          >
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-muted-foreground">{apt.duration} mins</p>
            </div>
          </motion.div>
        ))}
      </div>
    ...
    <ThemedCard industry={industry} className={className}>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium text-primary">3 available</span>
        </div>
        <div className="flex justify-between text-sm">
    ...
    <ThemedCard industry={industry} className={className}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Peak periods & trends</p>
        </div>
      </div>
