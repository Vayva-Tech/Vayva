            ...
            <div className="space-y-2">
              {['Purchase', 'Signup', 'Browse', 'Abandon'].map((trigger, index) => (
                <div key={trigger} className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-muted-foreground">{Math.floor(Math.random() * 50) + 10} workflows</span>
                </div>
              ))}
            </div>
          </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground">{test.variants.a.name}</p>
                </div>
                <div className="text-center p-3 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground">{test.variants.b.name}</p>
                </div>
              </div>
      ...
      <ThemedCard industry={industry}>
        ...
        <div className="space-y-4">
          {tests.filter(t => t.status === 'completed').map((test, index) => (
            <div key={test.id} className="p-4 border border-border rounded-xl">
          ...
          {rules.map((rule, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-xs text-muted-foreground capitalize">{rule.type}</span>
              </div>
