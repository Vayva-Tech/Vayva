...
export function OfflineSyncButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-md bg-amber-100 text-amber-800 hover:bg-amber-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
