...
export function KitchenBoard() {
  ...
  if (loading && orders.length === 0) {
    return (
      <div className="flex h-screen items-center justify-center">
        <Loader2 className="animate-spin text-text-tertiary" size={48} />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center p-8 bg-destructive/5 border-2 border-dashed border-destructive/20 rounded-xl">
        <div className="p-4 bg-background rounded-full shadow-sm mb-4">
          <Loader2 size={48} className="text-destructive/30" />
        </div>
  ...
  if (orders.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center p-8 bg-white/40 border-2 border-dashed border-border rounded-xl">
        <div className="p-4 bg-background rounded-full shadow-sm mb-4">
          <UtensilsCrossed size={48} className="text-text-tertiary" />
        </div>
