    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        <motion.div
          ...
          className="bg-background rounded-3xl shadow-2xl max-w-sm w-full p-8 relative overflow-hidden"
        >
          ...
          <div className="space-y-6 relative z-10">
                ...
                <Input key={i}
                  ...
                  className={cn(
                    ...
                    error
                      ...
                      : "border-border bg-white/40 focus:border-black focus:bg-background focus:shadow-lg",
                  )}
                  disabled={isLoading}
                />
              ))}
            ...
            <div className="flex flex-col gap-3 mt-4">
              ...
              {isLoading && (
                <div className="text-center text-xs text-text-tertiary animate-pulse">
