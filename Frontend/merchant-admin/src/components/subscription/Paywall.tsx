      ...
      <Card className="relative max-w-md w-full p-6 text-center">
        ...
        <div className="mt-8">
          ...
          <p className="text-muted-foreground mb-6">
            ...
            <span className="font-semibold text-primary">{requiredTier}</span> plan and above.
          </p>
          ...
          <div className="bg-muted rounded-lg p-4 mb-6">
            ...
            <div className="flex items-center justify-between text-sm mt-2">
              ...
              <span className="font-medium text-primary capitalize">{requiredTier}</span>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <Sparkle
          className={`h-5 w-5 ${isExpiring ? "text-amber-600" : "text-primary"}`}
        />
        <div>
          ...
          <p
            className={`text-sm ${
              isExpiring ? "text-amber-700" : "text-muted-foreground"
            }`}
          >
