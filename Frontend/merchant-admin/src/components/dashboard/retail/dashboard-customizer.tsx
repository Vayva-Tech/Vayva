...
function DraggableWidget({ widget, onRemove, onSettings }: DraggableWidgetProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="relative group bg-card border rounded-lg shadow-sm hover:shadow-md transition-all"
    >
      {/* Drag Handle */}
      <div
        {...attributes}
...
export function DashboardCustomizer({ 
  ...
  return (
    <div className={className}>
      ...
      <div className="flex items-center justify-between mb-4 p-3 border rounded-lg bg-accent/50">
