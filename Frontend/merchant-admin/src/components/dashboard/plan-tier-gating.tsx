...
function LockedFeatureOverlay({
  ...
  return (
    <div className="bg-background/90 backdrop-blur-sm rounded-xl border border-border p-6 max-w-md mx-auto">
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-text-secondary text-sm">
            This feature requires the <span className="font-medium text-text-primary">{requiredVariant.charAt(0).toUpperCase() + requiredVariant.slice(1)}</span> plan
          </p>
        </div>
