...
// import '../../../merchant-admin/src/styles/kitchen-themes.css';
...
export function TabletOptimizedKDS() {
  ...
  return (
    <div className={`${themeClasses[currentTheme]} min-h-screen bg-kds-background`}>
      ...
      <header className="border-b border-kds-card-border bg-kds-card-bg backdrop-blur-sm sticky top-0 z-40">
        <div className="px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-kds-text-primary">KDS</h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 bg-kds-card-bg border border-kds-card-border text-kds-text-primary rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-kds-primary"
              >
              ...
              <button
                ...
                className="p-2 text-kds-text-secondary hover:text-kds-text-primary transition-colors"
