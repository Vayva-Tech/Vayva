...
export function EventHeader({ event, planTier }: EventHeaderProps) {
  ...
  return (
    <div className="bg-card border-2 border-black rounded-lg shadow-[4px_4px_0px_#000000] p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-rose-500 rounded-lg flex items-center justify-center border-2 border-black">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button className="bg-gradient-to-r from-pink-500 to-rose-500 text-white border-2 border-black hover:brightness-110 font-black uppercase tracking-wide shadow-[2px_2px_0px_#000000]">
