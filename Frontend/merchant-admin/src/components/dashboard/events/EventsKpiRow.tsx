      ...
      {metricEntries.map(([key, data]: [string, any]) => {
        ...
        return (
          ...
          >
            ...
            {/* Icon */}
            <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-rose-500 rounded-lg flex items-center justify-center border-2 border-black mb-3 group-hover:scale-110 transition-transform">
