...
export function LiveTicketSales({ data, dashboardData }: LiveTicketSalesProps) {
  ...
  return (
    <div className="bg-white border-2 border-black rounded-xl p-6 shadow-[4px_4px_0px_#000000]">
      ...
      {/* Today's Summary */}
      {summary && (
        <div className="mb-4 p-3 bg-gradient-to-r from-pink-50 to-rose-50 border-2 border-black rounded-lg">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between text-xs">
              ...
              <div className="flex-1 mx-2 bg-gray-200 rounded-full h-3">
                <div 
                  className="bg-gradient-to-r from-pink-500 to-rose-500 h-3 rounded-full border border-black"
