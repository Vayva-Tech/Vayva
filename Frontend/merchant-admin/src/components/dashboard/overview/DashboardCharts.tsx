...
export const RevenueAreaChart = ({ data }: RevenueChartProps) => {
  return (
    <div className="bg-background p-6 rounded-3xl border border-border/40 shadow-sm h-96">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              itemStyle={{ color: "hsl(var(--text-primary))", fontSize: "12px", fontWeight: 600 }}
              labelStyle={{
...
export const OrdersBreakdownChart = ({ data }: OrdersChartProps) => {
  return (
    <div className="bg-background p-6 rounded-3xl border border-border/40 shadow-sm h-96 flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-bold text-text-primary">Order Volume</h3>
          <p className="text-sm text-text-tertiary">Daily Breakdown</p>
        </div>
      </div>
...
export const FulfillmentSpeed = ({
  ...
  return (
    <div className="bg-background p-6 rounded-3xl border border-border/40 shadow-sm flex flex-col justify-center h-full">
      <h3 className="text-sm font-bold text-text-tertiary uppercase tracking-widest mb-4">
        Fulfillment Speed
      </h3>

      <div className="flex items-end gap-2 mb-2">
        <span className="text-4xl font-bold text-text-primary">{avgTime}</span>
        <span className="text-sm text-text-tertiary mb-1">avg. delivery</span>
      </div>

      <div className="w-full h-3 bg-surface-2/50 rounded-full overflow-hidden mb-3">
        <div
          className={cn(
      ...
      <div className="flex justify-between items-center text-xs">
        <span className="text-text-tertiary">Target: {targetTime}</span>
        <span
