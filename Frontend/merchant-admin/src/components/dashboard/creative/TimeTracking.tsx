  ...
  return (
    <Card className={cn("relative overflow-hidden bg-card/90 backdrop-blur-sm border-white/20 shadow-lg", className)}>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Missing Hours Alert */}
        {missingHours > 0 && (
          <div className="flex items-center gap-2 p-3 rounded-md bg-amber-500/10 text-amber-600">
        ...
        <div className="grid grid-cols-2 gap-3 pt-3 mt-3 border-t">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">Top Tracker</span>
            </div>
            <p className="text-sm font-semibold">{topTracker.name}</p>
            <p className="text-xs text-muted-foreground">{topTracker.hours}h this week</p>
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-2 pt-3 mt-3 border-t">
            {unsubmittedCount > 0 && (
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Unsubmitted Timesheets</span>
