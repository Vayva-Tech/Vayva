...
export function TrialBanner() {
  ...
  return (
    <div 
      className="bg-gradient-to-r from-primary to-primary/80 text-text-inverse px-4 py-3 shadow-md relative z-50"
      role="banner"
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="bg-text-inverse/20 p-1.5 rounded-full">
            <Icon name="Sparkles" className="w-4 h-4 text-text-inverse" />
          </span>
          <div>
            <p className="font-semibold text-sm">You're in Trial Mode — Explore Risk-Free</p>
            <p className="text-xs text-text-inverse/80 hidden md:block">
        ...
        <Link href="/onboarding">
          <Button
            size="sm"
            variant="secondary"
            className="whitespace-nowrap font-medium text-xs h-8 bg-text-inverse text-primary hover:bg-text-inverse/90"
          >
