      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className="text-text-tertiary hover:text-text-primary hover:bg-surface-2/50 transition-colors p-1"
            variant="ghost"
            size="icon"
          >
            <Icon name="X" size={20} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        {items.map((item) => (
          <div
            ...
            className={cn(
              "flex items-center gap-4 p-4 rounded-xl border transition-all duration-300 relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
              item.isDone
                ? "bg-surface-2/50 border-border opacity-75"
            ...
            <div
              className={cn(
                ...
                item.isDone
                  ...
                  : "bg-surface-2/50 text-text-tertiary group-hover:bg-primary group-hover:text-text-inverse transition-all",
              )}
            >
              {item.isDone ? (
