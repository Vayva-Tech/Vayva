    ...
    return (
      ...
      >
        {[...Array(6)].map((_, i) => (
          <div 
            key={i}
            className="bg-surface-1 border border-border/40 rounded-xl p-4 flex flex-col items-center gap-3 h-full animate-pulse"
          >
            <div className="w-10 h-10 rounded-full bg-background/60" />
  ...
  return (
    ...
    >
      {actions.map((action) => (
        ...
        >
          <div className="bg-surface-1 border border-border/40 rounded-xl p-4 flex flex-col items-center gap-3 hover:border-primary/30 hover:bg-surface-2 transition-all text-center h-full focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2">
            <div className="w-10 h-10 rounded-full bg-surface-2 flex items-center justify-center text-text-primary group-hover:scale-110 transition-transform group-hover:bg-primary group-hover:text-text-inverse">
