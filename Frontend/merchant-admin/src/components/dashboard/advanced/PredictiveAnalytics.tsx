      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          {predictions.map((prediction) => {
            ...
            return (
              <div key={prediction.id} className="border-b border-border/40 pb-6 last:border-b-0 last:pb-0">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-text-primary">{prediction.metric}</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-3 text-sm">
                  ...
                  <div>
                    <p className="text-text-secondary">Predicted</p>
                    <p className="font-semibold text-text-primary">
                      {prediction.metric.includes('Rate') || prediction.metric.includes('$')
        ...
        {predictions.length === 0 && (
          <div className="text-center py-8">
            <Activity className="h-12 w-12 mx-auto text-text-tertiary mb-3" />
