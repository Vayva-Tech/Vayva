...
export function EmptyState({
  ...
  return (
    ...
    >
      {icon && (
        <div className="w-16 h-16 rounded-full bg-surface-2/50 flex items-center justify-center mb-4">
          {icon}
        </div>
      )}
...
export function Skeleton({ className }: SkeletonProps) {
  return <div className={cn("animate-pulse bg-surface-2/50 rounded", className)} />;
}
