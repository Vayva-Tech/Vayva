  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("label", {
        ...
        className: cn(
          "w-11 h-6 rounded-full relative transition-colors focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary cursor-pointer",
        ...
        children: _jsx("span", {
          className: cn(
            "block w-5 h-5 bg-background rounded-full shadow-sm transition-transform transform",
