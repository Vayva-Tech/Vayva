                ...
                {category.items.map((item) => (
                  <Link key={item.id} href={item.href}>
                    <div
                      ...
                      } ${item.isPro ? 'border border-primary/20' : ''}`}
                    >
                      {item.icon}
      ...
      <div className="p-4 border-t border-border">
        <div className="space-y-3">
          ...
          <div className="p-3 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
            ...
            <button className="w-full py-1.5 px-3 bg-primary text-primary-foreground rounded text-xs font-medium hover:opacity-90 transition-opacity">
              Upgrade Now
            </button>
          </div>
        </div>
