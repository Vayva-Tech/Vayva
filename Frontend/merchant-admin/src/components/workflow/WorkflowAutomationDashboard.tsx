    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="lg:col-span-1 space-y-4">
        ...
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="space-y-2">
            <button className="w-full flex items-center gap-2 p-2 text-sm rounded-lg hover:bg-muted transition-colors">
            ...
            <button className="w-full flex items-center gap-2 p-2 text-sm rounded-lg hover:bg-muted transition-colors text-red-600">
      ...
      <div className="lg:col-span-3">
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="h-96 bg-gradient-to-br from-muted/30 to-muted/10 rounded-xl border-2 border-dashed border-border relative overflow-hidden">
            {selectedWorkflow ? (
              <div className="p-6">
                  ...
                  <div className="flex gap-4">
                    {selectedWorkflow.nodes.slice(0, 3).map((node: WorkflowNode, index: number) => (
                      <div key={node.id} className="relative">
                        ...
                        {index < 2 && (
                          <ArrowRight className="absolute -right-6 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                        )}
                      </div>
                    ))}
                  </div>
