    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-text-secondary">Loading your social connections...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-6">
        <h2 className="text-xl font-bold text-text-primary mb-4 text-center">Platform Comparison</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {platforms.map((platform) => (
          <div 
            key={platform.id}
            className="bg-white border-2 border-border rounded-3xl p-8 hover:shadow-2xl transition-all duration-300"
          >
            {/* Platform Header */}
            ...
            {!platform.connected && (
              <div className="mb-6">
                <h3 className="font-bold text-text-primary mb-3">Setup Instructions</h3>
                    ...
                    <div key={step.step} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-text-tertiary">({step.timeEstimate})</span>
                        </div>
                      </div>
                    </div>
                  ))}
