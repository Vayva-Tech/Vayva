  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-vayva-green to-emerald-500 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {platforms.map((platform) => (
          <div 
            key={platform.id}
            className="bg-white border-2 border-border rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
          >
            {/* Header */}
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-black text-text-primary">{platform.name}</h2>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-text-primary">{platform.whyFree}</span>
                  <span className="text-sm text-text-secondary block">No hidden costs ever</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-text-primary">Setup in {platform.setupTime}</span>
                  <span className="text-sm text-text-secondary block">Simple copy/paste process</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-text-primary">{platform.userBase} users</span>
                  <span className="text-sm text-text-secondary block">Reach more customers</span>
                </div>
              </div>
            </div>
      ...
      {showSetup && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full">
            <div className="bg-gradient-to-r from-vayva-green to-emerald-500 p-6 rounded-t-3xl">
            ...
            <div className="p-6 space-y-6">
              <div className="text-center space-y-2">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto">
                  {showSetup === 'telegram' ? (
                    ...
                    <DiscordLogo className="w-8 h-8 text-indigo-500" />
                  )}
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-border rounded-xl focus:ring-2 focus:ring-vayva-green focus:border-transparent font-mono text-sm"
                />
              </div>
