    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {platforms.map((platform) => (
          <div 
            key={platform.id}
            className="bg-background border-2 border-border rounded-2xl p-5 hover:shadow-lg transition-all duration-300 group"
          >
            ...
            {platform.requiredFields.map((field) => (
              <div key={field}>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-vayva-green focus:border-transparent"
