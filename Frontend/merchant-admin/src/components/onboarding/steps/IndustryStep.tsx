...
export default function IndustryStep() {
  ...
  const getDesignCategoryColor = (category: string) => {
    switch (category) {
      case "glass": return "from-pink-100 to-rose-100";
      ...
      <div className="mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-2xl border border-border bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-text-primary placeholder-text-tertiary"
          />
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected 
                  ? `border-primary bg-primary/5 ring-2 ring-primary ${getDesignCategoryBorder(industry.designCategory)}` 
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className={`
                    ...
                    ${isSelected ? "bg-primary text-primary-foreground" : "bg-surface-subtle text-text-secondary"}
                  `}>
              ...
              <div className="mt-3 pt-3 border-t border-border/50">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-background/50 text-text-tertiary">
