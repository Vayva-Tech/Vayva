          ...
          <div className="space-y-2 relative">
            ...
            <div className="relative">
              <Input
                ...
                className="h-12 rounded-xl border-border focus:border-vayva-green focus:ring-vayva-green/20 pr-10"
              />
              {selectedBankCode && (
                <button
                  type="button"
              ...
              {!selectedBankCode && (
                <CaretDown className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-text-tertiary pointer-events-none" />
              )}
            </div>
            {loadingBanks && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`h-12 rounded-xl border-border focus:border-vayva-green focus:ring-vayva-green/20 ${resolvedName ? "border-vayva-green pr-10" : ""} ${!selectedBankCode ? "bg-background/50" : ""}`}
              />
              {resolving && (
            ...
            {!selectedBankCode && (
              <p className="text-xs text-text-tertiary">Please select a bank first</p>
            )}
          </div>
