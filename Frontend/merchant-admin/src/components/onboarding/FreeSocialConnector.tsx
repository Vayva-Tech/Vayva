  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-3">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-gradient-to-r from-vayva-green to-emerald-500 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {platforms.map((platform) => (
          <div 
            key={platform.id}
            className="bg-background border-2 border-border rounded-2xl p-6 hover:shadow-xl transition-all duration-300 group"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-text-primary">{platform.name}</h3>
            ...
            {/* Setup Steps */}
            <div className="mb-6">
              <h4 className="font-bold text-text-primary text-sm mb-2">Setup Steps:</h4>
