      ...
      {!overviewLoading && overview && (
        ...
        >
          ...
          <ThemedCard industry={store?.industrySlug || 'default'}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Attributed Revenue</p>
                <p className="text-2xl font-bold" style={{ color: colors.secondary }}>
      ...
      <ThemedCard industry={store?.industrySlug || 'default'}>
        ...
        <div className="space-y-4">
          {channels?.sort((a, b) => (b.roi || 0) - (a.roi || 0)).map((channel, index) => (
            <div key={channel.channel} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
