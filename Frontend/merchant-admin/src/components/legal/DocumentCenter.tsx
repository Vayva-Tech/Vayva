...
export function DocumentCenter({ data }: DocumentCenterProps) {
  ...
  return (
    <Card className="p-6 border-l-4 border-purple-700 shadow-lg backdrop-blur-sm bg-white/90">
      <div className="flex items-center gap-2 mb-4">
        <FileText size={24} className="text-purple-700" />
        <h2 className="text-xl font-bold text-text-primary">Document Center</h2>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        ...
        <div className="p-3 bg-amber-50 rounded-lg">
          ...
          <div className="text-xs text-amber-700">In Review</div>
        </div>
      ...
      <div className="space-y-2 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-semibold text-text-primary">{data.eSignaturePending}</span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-text-secondary">Template Library</span>
          <span className="font-semibold text-text-primary">{data.templateCount}</span>
        </div>
      </div>
    </Card>
  );
