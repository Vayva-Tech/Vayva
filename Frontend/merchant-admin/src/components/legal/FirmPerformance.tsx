  ...
  return (
    <Card className="p-6 border-l-4 border-blue-900 shadow-lg backdrop-blur-sm bg-white/90">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-bold text-text-primary">Firm Performance</h2>
      </div>

      <div className="grid grid-cols-3 gap-4">
        {/* Active Cases */}
        <div className="space-y-2">
          <div className="text-sm text-text-secondary">Active Cases</div>
        ...
        {/* Billable Hours MTD */}
        <div className="space-y-2">
          <div className="text-sm text-text-secondary">Billable Hours MTD</div>
          <div className="text-3xl font-bold text-text-primary font-serif">
        ...
        {/* Collections MTD */}
        <div className="space-y-2">
          <div className="text-sm text-text-secondary">Collections MTD</div>
          <div className="text-3xl font-bold text-text-primary font-serif">
