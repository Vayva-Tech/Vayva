          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">{caseItem.title}</p>
              </div>
            ...
            <div key={i} className="flex items-center justify-between p-3 border border-border rounded-lg hover:bg-muted/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Case #2024-{100+i} • Uploaded 2 days ago</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            {[1,2,3,4,5].map(i => (
              <div key={i} className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Client: Johnson & Associates</p>
                </div>
