    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-text-primary">Staff Schedule</h3>
        </div>
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
              ...
              <Button
                ...
                className={`w-full flex items-center gap-2 p-2 rounded-lg border text-left transition-colors h-auto justify-start ${
                  selectedStaff === member.id
                    ...
                    : "border-border/40 hover:bg-background/50"
                }`}
              >
                <div
                ...
                <Button
                  ...
                  className="text-text-tertiary hover:text-red-500 h-auto p-1"
                >
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-7 gap-1 mb-2">
            {weekDays.map((day) => (
              <div
                key={day.toString()}
                className="text-center py-2 text-xs font-medium text-text-secondary"
              >
                {format(day, "EEE")}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button
                      ...
                      className="text-primary hover:bg-primary/10 rounded p-0.5 disabled:opacity-30"
                    >
                  ...
                  <div className="space-y-1">
                    {dayShifts.map((shift) => {
                      ...
                      return (
                        <div
                          key={shift.id}
                          className="p-1.5 rounded text-xs bg-background border border-border/40"
                        >
                          ...
                          <div className="flex items-center gap-1 text-text-tertiary mt-1">
          ...
          <div className="flex flex-wrap gap-2">
            {shifts
              ...
              .map((shift) => (
                <div
                  key={shift.id}
                  className="flex items-center gap-2 px-3 py-2 bg-background rounded-lg border border-border/40 text-sm"
                >
