...
export const GradientOrbs: React.FC = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
      <div 
        className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-indigo-300 to-purple-300 rounded-full opacity-30 blur-3xl"
        style={{
          animation: 'float 20s infinite ease-in-out',
        }}
      />
      <div 
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-pink-300 to-rose-300 rounded-full opacity-30 blur-3xl"
        style={{
