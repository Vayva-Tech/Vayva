  ...
  return (
    <Card className="p-6 bg-[#252525] border-[#333333]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-bold text-lg text-text-primary">Security Log</h3>
          ...
          >
            <div className="flex items-start gap-2 mb-2">
              ...
              <div className="flex-1">
                <div className="text-sm text-text-primary">{incident.description}</div>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-text-secondary">Officer: {incident.officerName}</span>
            </div>
          </div>
        ))}
      ...
      <div className="mt-4 pt-4 border-t border-[#333333] text-xs text-text-secondary">
