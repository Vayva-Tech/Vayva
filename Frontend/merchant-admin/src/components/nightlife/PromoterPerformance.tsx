  ...
  return (
    <Card className="p-6 bg-[#252525] border-[#333333]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-bold text-lg text-text-primary">Promoter Performance</h3>
          <p className="text-sm text-text-secondary">Top performers tonight</p>
        </div>
      </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1">
                <div className="font-medium text-text-primary">{promoter.promoterName}</div>
