  ...
  return (
    <Card className="p-6 bg-[#252525] border-[#333333]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-bold text-lg text-text-primary">Table Reservations</h3>
          <p className="text-sm text-text-secondary">Main Room Floor Plan</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-4 p-4 bg-[#1A1A1A] rounded-lg">
        {tables.slice(0, 16).map((table) => (
          ...
          >
            <div className="text-xs font-bold text-text-primary">{table.tableNumber}</div>
            <div className="text-xs text-text-secondary">{table.capacity} guests</div>
