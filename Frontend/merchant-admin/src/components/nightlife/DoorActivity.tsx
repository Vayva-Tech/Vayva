  ...
  return (
    <Card className="p-6 bg-[#252525] border-[#333333]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-bold text-lg text-text-primary">Door Activity</h3>
          <p className="text-sm text-text-secondary">Last hour statistics</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="p-3 bg-[#1A1A1A] rounded-lg text-center">
          ...
          <div className="text-xl font-bold text-text-primary">{stats?.admitted || 0}</div>
          <div className="text-xs text-text-secondary">Admitted</div>
        </div>
        <div className="p-3 bg-[#1A1A1A] rounded-lg text-center">
          <PersonSimpleWalk size={20} className="mx-auto mb-1 text-red-400" />
          <div className="text-xl font-bold text-text-primary">{stats?.denied || 0}</div>
          <div className="text-xs text-text-secondary">Denied</div>
        </div>
        <div className="p-3 bg-[#1A1A1A] rounded-lg text-center">
          <UserPlus size={20} className="mx-auto mb-1 text-yellow-400" />
          <div className="text-xl font-bold text-text-primary">{stats?.waiting || 0}</div>
      ...
      {/* Demographics */}
      <div className="mb-4">
        <div className="text-xs text-text-secondary mb-2">Gender Distribution</div>
      ...
      {/* Age Groups */}
      <div className="mb-4">
        <div className="text-xs text-text-secondary mb-2">Age Groups</div>
        <div className="grid grid-cols-4 gap-2">
          {Object.entries(stats?.ageGroups || {}).map(([group, percentage]) => (
            <div key={group} className="text-center">
              <div className="text-xs text-text-primary font-medium">{group}</div>
      ...
      <div className="pt-4 border-t border-[#333333]">
        <div className="flex items-center justify-between text-sm">
          <div>
            <span className="text-text-secondary">Cover Charge: </span>
