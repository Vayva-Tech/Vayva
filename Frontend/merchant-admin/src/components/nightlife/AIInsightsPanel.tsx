    ...
    return (
      <Card className="p-6 bg-gradient-to-r from-purple-950/30 to-cyan-950/30 border-purple-500/20">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-bold text-lg text-text-primary">AI Insights</h3>
            <p className="text-sm text-text-secondary">Upgrade to Pro for intelligent recommendations</p>
          </div>
        </div>
    ...
    <Card className="p-6 bg-gradient-to-r from-purple-950/30 to-cyan-950/30 border-purple-500/20">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-lg text-text-primary">AI Insights</h3>
            <p className="text-sm text-text-secondary">Intelligent recommendations for tonight</p>
          </div>
        </div>
        ...
        {insights.map((insight) => (
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              <div className="text-text-secondary">{insight.details}</div>
              <div className="flex items-start gap-2">
                <span className="text-purple-400 font-medium">💡 Recommendation:</span>
                <span className="text-text-primary">{insight.recommendation}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-green-400 font-medium">📈 Predicted Impact:</span>
                <span className="text-text-primary">{insight.predictedImpact}</span>
              </div>
            </div>
      ...
      <div className="mt-6 pt-4 border-t border-white/10 text-xs text-text-secondary">
