      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center gap-2 p-3 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity">
              <ArrowsClockwise className="h-4 w-4" />
              Sync All Channels
            </button>
            <button className="w-full flex items-center gap-2 p-3 border border-border rounded-lg hover:bg-muted transition-colors">
        ...
        <ThemedCard industry={store?.industrySlug || 'default'}>
          ...
          <div className="space-y-4">
            {channelMetrics
              ...
              .slice(0, 3)
              .map((metric, index) => (
                <div key={metric.channelId} className="p-3 border border-border rounded-lg">
