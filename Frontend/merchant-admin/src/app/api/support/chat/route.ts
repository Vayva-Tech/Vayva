...
export const POST = withVayvaAPI(PERMISSIONS.SUPPORT_VIEW, async (req: NextRequest, { storeId }: { storeId: string }) => {
    try {
        ...
        logger.error("[SUPPORT_CHAT] Failed to process message", { storeId, error });
