...
export const POST = withVayvaAPI(PERMISSIONS.SUPPORT_MANAGE, async (req: NextRequest, { storeId, user }: { storeId: string; user: { id: string; email?: string | null } }) => {
    try {
        ...
        logger.error("[SUPPORT_CREATE] Failed to create support ticket", { storeId, error });
