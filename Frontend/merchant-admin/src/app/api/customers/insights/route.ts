...
export const GET = withVayvaAPI(PERMISSIONS.CUSTOMERS_VIEW, async (req: NextRequest, { storeId }: { storeId: string }) => {
    try {
        ...
        logger.error("[CUSTOMERS_INSIGHTS_GET] Failed to fetch customer insights", { storeId, error });
