          ...
          <div className="flex gap-3 overflow-x-auto pb-2">
            <button
              ...
              className={`px-4 py-2 rounded-full whitespace-nowrap transition-colors ${
                !selectedCategory ? "bg-primary text-white" : "bg-muted hover:bg-muted/80"
              }`}
            >
              All
            </button>
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-full whitespace-nowrap transition-colors ${
                  selectedCategory === cat.slug ? "bg-primary text-white" : "bg-muted hover:bg-muted/80"
                }`}
              >
      ...
      <div className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/market/cart" className="text-primary hover:underline flex items-center gap-1">
