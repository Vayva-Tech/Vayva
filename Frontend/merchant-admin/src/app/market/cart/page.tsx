    ...
    return (
      <MarketShell>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
          <Icon name="ShoppingCart" size={64} className="text-muted-foreground mb-6" />
          <h1 className="text-2xl font-bold mb-2">Your cart is empty</h1>
          <p className="text-muted-foreground mb-6">Browse the marketplace to discover amazing products</p>
          <Link href="/market">
