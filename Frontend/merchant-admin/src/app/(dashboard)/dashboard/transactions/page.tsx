      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-text-tertiary">Payments, payouts & settlements</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-text-tertiary font-medium">Total Revenue</p>
        ...
        <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-text-tertiary font-medium">Total Payouts</p>
        ...
        <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-text-tertiary font-medium">Pending Balance</p>
        ...
        <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-text-tertiary font-medium">Fees</p>
            <TrendingUp className="w-4 h-4 text-red-500" />
          </div>
          <p className="text-2xl font-black text-text-tertiary">
  ...
  return (
    <table className="w-full">
      <thead className="bg-background/50 border-b border-border">
        <tr>
          <th className="text-left p-4 text-sm font-bold text-text-secondary">Transaction</th>
          <th className="text-left p-4 text-sm font-bold text-text-secondary">Type</th>
          <th className="text-left p-4 text-sm font-bold text-text-secondary">Status</th>
          <th className="text-right p-4 text-sm font-bold text-text-secondary">Amount</th>
            ...
            <td className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {t.orderNumber && (
                    <p className="text-xs text-text-tertiary">Order #{t.orderNumber}</p>
                  )}
                </div>
              </div>
            </td>
...
function SettlementsTable({ settlements }: { settlements: Settlement[] }) {
  if (settlements.length === 0) {
    return (
      <div className="p-12 text-center">
        ...
        <h3 className="text-lg font-bold text-text-primary mb-2">No settlements yet</h3>
        <p className="text-text-secondary">
  ...
  return (
    <table className="w-full">
      <thead className="bg-background/50 border-b border-border">
        <tr>
          <th className="text-left p-4 text-sm font-bold text-text-secondary">Period</th>
          <th className="text-right p-4 text-sm font-bold text-text-secondary">Transactions</th>
          <th className="text-right p-4 text-sm font-bold text-text-secondary">Gross</th>
          <th className="text-right p-4 text-sm font-bold text-text-secondary">Fees</th>
          <th className="text-right p-4 text-sm font-bold text-text-secondary">Net</th>
