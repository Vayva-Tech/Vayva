...
export default function SetupChecklistPage() {
  ...
  if (loading)
    return (
      <div className="p-8 flex items-center justify-center gap-2 text-text-tertiary">
              ...
              <div className="flex items-center">
                {issue.actionUrl && (
                  <a
                    ...
                    className="px-4 py-2 bg-background/70 backdrop-blur-xl border border-border shadow-sm rounded-lg text-sm font-bold hover:bg-background/30"
                  >
                    Fix Now
                  </a>
                )}
