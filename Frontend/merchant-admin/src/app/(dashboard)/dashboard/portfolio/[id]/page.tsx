    ...
    return (
      <div className="p-6">
        <div className="animate-pulse space-y-4">
          <div className="h-8 bg-background/50 rounded w-1/3" />
          <div className="h-64 bg-background/50 rounded-lg" />
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-text-secondary text-sm">{project.slug}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 space-y-4">
          ...
          <div>
            ...
            <Input value={project.slug} disabled className="mt-1 bg-background/50" />
          </div>
        </Card>
        ...
        <Card className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {images.length === 0 && (
              <div className="col-span-2 aspect-video bg-background/50 rounded-lg flex items-center justify-center text-text-tertiary text-sm">
                No images added
              </div>
            )}
          </div>
