...
export default function StorefrontSettingsPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-text-tertiary">Checkout, receipts & branding</p>
          </div>
        </div>
        <Button
          onClick={handleSave}
      ...
      {/* Checkout Settings */}
      {activeTab === "checkout" && (
        <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border shadow-sm p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center justify-between p-4 border rounded-lg cursor-pointer hover:bg-background/30">
