        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-6 pt-6 border-t border-slate-100">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  className="w-full p-2 border border-slate-200 rounded-lg text-sm bg-background/70 backdrop-blur-xl"
                  value={settings?.tone}
              ...
              <div className="pt-6 border-t border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-semibold text-slate-900">Multimodal Features</h4>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="allowImageUnderstanding" className="text-sm font-medium text-slate-700">
                        Image Understanding
                      </Label>
                      <p className="text-xs text-slate-400">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="allowVoiceNotes" className="text-sm font-medium text-slate-700">
              ...
              <div className="pt-6 border-t border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-semibold text-slate-900">Behavior & Style</h4>
                </div>
          ...
          <Card className="p-6 mt-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900">Chat with Your AI</h3>
                <p className="text-sm text-slate-500">
            ...
            {/* Chat Messages */}
            <div className="bg-slate-50 rounded-lg p-4 h-80 overflow-y-auto mb-4 space-y-4">
          ...
          <Card className="p-6 mt-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">About Your Business</h3>
                  <p className="text-sm text-slate-500">
            ...
            {!showContextForm && merchantContext.publicInfo ? (
              <div className="bg-slate-50 rounded-lg p-4">
                <p className="text-sm text-slate-600 line-clamp-3">{merchantContext.publicInfo}</p>
              </div>
            ) : (
              showContextForm && (
                <div className="space-y-4">
...
`.trim();
        ...
        <div className="space-y-6">
          <Card className="p-6 bg-background/40 backdrop-blur-sm border-none">
            <h4 className="font-semibold text-slate-900 mb-4 flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-amber-500" />
              Agent Stats
            </h4>
            <div className="space-y-4">
              <div className="bg-background/70 backdrop-blur-xl p-3 rounded-lg border border-slate-100 flex items-center justify-between">
              ...
              <div className="bg-background/70 backdrop-blur-xl p-3 rounded-lg border border-slate-100 flex items-center justify-between">
                ...
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded-full ${settings?.enabled ? "bg-emerald-100 text-emerald-700" : "bg-slate-200 text-slate-600"}`}
                >
