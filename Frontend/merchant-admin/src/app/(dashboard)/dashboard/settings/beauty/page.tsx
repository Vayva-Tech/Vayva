  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-text-secondary">Configure your salon operations, services, and preferences</p>
      </div>
              ...
              {categories.map((category) => (
                <div key={category.name} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div>
                    ...
                    <span className="text-text-secondary text-sm ml-2">({category.count} services)</span>
                  </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Tiered pricing by stylist level</span>
              </label>
              ...
              {[
                ...
                <div key={staff.level} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div>
                    ...
                    <span className="text-text-secondary text-sm ml-2">({staff.count} staff)</span>
                  </div>
                  <span className="text-accent-primary">{staff.rate}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              ...
              <label className="flex items-center gap-2">
                ...
                <span className="text-text-secondary">Allow double-booking</span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Enable online booking</span>
              </label>
              <div className="flex items-center gap-4 pl-6">
              ...
              <div className="flex items-center gap-4 pl-6">
                ...
                <span className="text-text-secondary">hours before</span>
              </div>
              <label className="flex items-center gap-2 pl-6">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Deposit required for services &gt;$100</span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Require before/after for chemical services</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Require approval before publishing</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Add salon logo watermark</span>
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Auto-post to Instagram</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Auto-post to Facebook</span>
              </label>
              <div>
          ...
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              ...
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Store signed consent forms</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Parent signature required for minors</span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Enable retail sales</span>
              </label>
              <div className="flex items-center gap-4 pl-6">
          ...
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Track product usage</span>
              </label>
              <div className="flex items-center gap-4 pl-6">
              ...
              <label className="flex items-center gap-2 pl-6">
                <input type="checkbox" className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Auto-reorder (manual approval required)</span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-4">
              ...
              {[
                ...
                <div key={pkg.name} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div>
                    ...
                    <span className="text-accent-primary ml-2">{pkg.price}</span>
              ...
              {[
                ...
                <div key={plan.name} className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-accent-primary/20">
                  <div>
                    ...
                    <span className="text-accent-primary ml-2">{plan.price}</span>
                    <p className="text-text-secondary text-sm mt-1">{plan.benefit}</p>
                  </div>
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="glass-button">
                      <Edit className="w-3 h-3" />
          ...
          <div>
            ...
            <div className="space-y-3 bg-white/5 p-4 rounded-lg">
              <label className="flex items-center gap-2">
                <input type="checkbox" defaultChecked className="rounded bg-white/10 border-white/20" />
                <span className="text-text-secondary">Sell gift cards</span>
              </label>
              <div>
