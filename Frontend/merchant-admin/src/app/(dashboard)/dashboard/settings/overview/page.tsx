          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {group?.items?.map((item) => (
              <Link key={item.href} href={item.href} className="block group">
                <div className="h-full rounded-[20px] border border-border/60 bg-background/70 backdrop-blur-xl p-4 flex items-center gap-4 transition-all duration-200 hover:shadow-elevated hover:border-primary/20">
                  <div
                  ...
                  <ChevronRight className="h-4 w-4 text-text-tertiary shrink-0 group-hover:text-primary transition-colors" />
                </div>
              </Link>
            ))}
          </div>
