                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">{addon.tagline}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-center">
                        ...
                        <span className="text-xs text-muted-foreground">{addon.stats?.reviewCount ?? 0} reviews</span>
                      </div>
                      <div className="text-center">
                        <div className="flex items-center gap-1">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-1">
                                  {[1, 2, 3, 4, 5].map((star) => (
                                    <svg
                                      key={star}
                                      className={`w-4 h-4 ${star <= Math.round(addon.stats?.rating ?? 0) ? "text-yellow-500 fill-yellow-500" : "text-muted-foreground"}`}
                                      viewBox="0 0 20 20"
                                    >
                                ...
                                <p className="text-sm text-muted-foreground mt-1">{addon.stats?.reviews ?? 0} reviews</p>
                              </div>
                            </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                      ...
                      {addon.docs?.setup && (
                        <a href={addon.docs.setup} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                          Documentation
                        </a>
                      )}
                    </div>
