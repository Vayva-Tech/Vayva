  ...
  return (
    ...
    >
      <Card className={cn(
        ...
        isInstalled && "ring-2 ring-primary/20"
      )}>
        {/* Preview Image */}
        <div className="aspect-video bg-muted relative overflow-hidden" onClick={onView}>
        ...
        <CardHeader className="p-4 pb-2">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground line-clamp-2">{addon.tagline}</p>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-4 pt-0">
          <div className="flex items-center gap-4 text-sm">
            <div className="flex items-center">
              ...
              <span className="text-muted-foreground ml-1">({addon.stats?.reviewCount ?? 0})</span>
            </div>
