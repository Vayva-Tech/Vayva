    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary">Manage before/after photos and portfolio</p>
        </div>
        <Button 
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-2 border-dashed border-white/20 rounded-lg p-8 text-center hover:border-accent-primary/50 transition-colors cursor-pointer">
                ...
                <div onClick={() => fileInputRef.current?.click()}>
                  {uploading ? (
                    <Loader2 className="w-12 h-12 mx-auto animate-spin text-accent-primary mb-4" />
                  ) : (
                    <>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-text-secondary">This is a before/after photo</span>
                  </label>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="rounded bg-white/10 border-white/20"
                    />
                    <span className="text-text-secondary">Requires approval before publishing</span>
                  </label>
                </div>
              </div>
            </div>
