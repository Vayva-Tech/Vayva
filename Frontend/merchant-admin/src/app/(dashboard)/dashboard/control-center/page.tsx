      ...
      <DashboardCard>
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-slate-900">Storefront Status</h3>
              <p className="text-sm text-slate-500">
                Template: <span className="font-medium text-slate-900">{draft?.templateName || "Not selected"}</span>
              </p>
            </div>
          </div>
          {draft?.hasChanges ? (
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            ...
            className="rounded-xl gap-2 ml-auto bg-slate-900 hover:bg-slate-800"
          >
      ...
      <Tabs defaultValue="website" className="w-full">
        ...
        <TabsContent value="website">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <DashboardCard>
              ...
              <Button onClick={() => router.push("/dashboard/templates")} className="w-full gap-2 rounded-xl bg-slate-900 hover:bg-slate-800">
                <Layers className="w-4 h-4" />
                Browse Templates
              </Button>
            </DashboardCard>
            ...
            <DashboardCard>
              ...
              <Button onClick={handleOpenWebStudio} className="w-full gap-2 rounded-xl bg-slate-900 hover:bg-slate-800">
                <Pencil className="w-4 h-4" />
                Open WebStudio
              </Button>
            </DashboardCard>
            ...
            <DashboardCard>
              ...
              <p className="text-sm text-slate-500 mb-4">
                {storeSlug ? (
                  <>Current domain: <span className="font-medium text-slate-900">{storeSlug}.vayva.ng</span></>
                ) : (
        ...
        <TabsContent value="extensions">
          <div className="space-y-6">
            ...
            <div className="bg-background/30 rounded-3xl p-8 border border-border/40">
              <ExtensionsGallery />
            </div>
          </div>
        </TabsContent>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  ...
                  {history.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={5} className="text-center py-8 text-text-tertiary">
                        No history found.
                      </TableCell>
                    </TableRow>
                  )}
