...
export default function LeadsPage() {
  ...
  return (
    <DashboardPageShell
      ...
      actions={
        <Button className="bg-success text-text-inverse" onClick={() => setShowAddModal(true)}>
      ...
      <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border overflow-hidden">
        {loading ? (
          <div className="p-8 text-center" aria-live="polite" role="status">
            <div className="animate-spin h-8 w-8 border-2 border-border border-t-text-primary rounded-full mx-auto" />
            <span className="sr-only">Loading leads...</span>
          </div>
        ) : leads.length === 0 ? (
          <div className="p-12 text-center">
            <User className="h-12 w-12 text-text-tertiary mx-auto mb-4" />
            <h3 className="font-semibold text-text-primary">No leads yet</h3>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handleAddLead} className="space-y-4 mt-4">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                type="submit"
                className="flex-1 bg-success text-text-inverse"
