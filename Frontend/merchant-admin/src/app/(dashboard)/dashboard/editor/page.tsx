    ...
    <div className="space-y-10 max-w-6xl mx-auto pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="relative rounded-[40px] border border-border/40 bg-background/50 backdrop-blur-xl overflow-hidden group shadow-2xl transition-all duration-500 hover:border-primary/20 h-full">
            {/* Vayva Green Glow */}
            <div className="absolute -top-32 -right-32 w-96 h-96 bg-primary/10 rounded-full blur-[100px] pointer-events-none group-hover:bg-primary/15 transition-colors duration-700" />

            <div className="relative p-12 flex flex-col items-center text-center space-y-8">
              <div className="w-24 h-24 rounded-[32px] bg-primary/10 flex items-center justify-center shadow-2xl shadow-primary/10 transition-transform duration-500 group-hover:scale-110">
              ...
              <div className="space-y-3">
                ...
                {site?.currentTemplate && (
                  <div className="flex flex-col items-center gap-2">
                    <div className="px-3 py-1 rounded-full bg-background/30 border border-border/40 text-xs font-bold text-text-secondary">
                      Editing:{" "}
                ...
                <p className="text-base font-medium text-text-secondary max-w-md leading-relaxed">
                  {site?.currentTemplate
              ...
              {site?.currentTemplate ? (
                <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center">
                  <Button
                    ...
                    disabled={opening}
                    className="rounded-2xl h-14 px-8 gap-3 bg-text-primary text-text-inverse hover:bg-zinc-800 shadow-xl active:scale-95 transition-all flex-1"
                  >
                    {opening ? (
                  ...
                  <Button
                    ...
                    className="rounded-2xl h-14 px-8 gap-3 border-border/60 hover:bg-background/30 transition-all flex-1 active:scale-95"
                  >
                ...
                <Button
                  ...
                  className="rounded-2xl h-14 px-8 gap-3 bg-primary text-text-inverse hover:bg-primary-hover shadow-xl shadow-primary/20 active:scale-95 transition-all"
                >
              ...
              {site?.currentTemplate && (
                <Button
                  variant="link"
                  onClick={() => router.push("/dashboard/templates")}
                  className="text-xs font-bold text-text-tertiary hover:text-text-primary underline underline-offset-4 h-auto p-0"
                >
                  Change template
                </Button>
              )}
        ...
        <div className="space-y-6">
          <div className="p-8 rounded-[32px] border border-border/40 bg-background/50 backdrop-blur-xl space-y-6 shadow-sm">
            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-text-tertiary">
              Editor Tips
            </h3>
