  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-background/70 backdrop-blur-xl p-4 rounded-xl border border-border/40">
          <p className="text-sm text-text-tertiary">Active Incidents</p>
          <p className="text-2xl font-bold text-text-primary">{stats.active}</p>
        </div>
        <div className="bg-background/70 backdrop-blur-xl p-4 rounded-xl border border-border/40">
          <p className="text-sm text-text-tertiary">Dispatched</p>
          <p className="text-2xl font-bold text-info">{stats.dispatched}</p>
        </div>
        <div className="bg-background/70 backdrop-blur-xl p-4 rounded-xl border border-border/40">
          <p className="text-sm text-text-tertiary">Resolved Today</p>
      ...
      {/* Active Incidents */}
      <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border/40 shadow-sm">
        <div className="p-6 border-b border-border/40 flex items-center justify-between">
          <h2 className="font-semibold text-text-primary">Active Incidents</h2>
          <Button
            variant="outline"
            size="sm"
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="font-medium text-text-primary">No active incidents</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <h3 className="font-medium text-text-primary">{incident.type}</h3>
                    ...
                    {incident.assignedResponder && (
                      <div className="mt-2 text-xs text-text-secondary bg-info/10 inline-flex items-center gap-1 px-2 py-1 rounded">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-background/70 backdrop-blur-xl p-6 rounded-xl border border-border/40">
          <h3 className="font-semibold text-text-primary mb-2">Response Team</h3>
          <p className="text-sm text-text-tertiary">
            Emergency Hotline: <strong className="text-text-primary">911</strong>
          </p>
          <p className="text-sm text-text-tertiary mt-1">
            Dispatch Center: <strong className="text-text-primary">(555) 123-RESCUE</strong>
          </p>
          <p className="text-xs text-text-tertiary mt-3">
            Average response time: <strong className="text-success">12 minutes</strong>
          </p>
        </div>
      </div>
    </DashboardPageShell>
