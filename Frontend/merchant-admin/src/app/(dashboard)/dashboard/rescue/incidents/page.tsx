...
export default function IncidentsListPage() {
  ...
  return (
    ...
    >
      ...
      {/* Incidents Table */}
      <div className="bg-background/70 backdrop-blur-xl rounded-xl border border-border/40 shadow-sm overflow-hidden">
        {loading ? (
            ...
            <table className="w-full">
              <thead className="bg-background/50 border-b border-border/40">
                <tr>
                  ...
                  <th className="text-left p-4 text-sm font-medium text-text-secondary">Location</th>
                  ...
                  <th className="text-left p-4 text-sm font-medium text-text-secondary">Responder</th>
              ...
              <tbody className="divide-y divide-border/40">
                {filteredIncidents.map((incident) => (
                  ...
                  >
                    <td className="p-4">
                      <div className="font-medium text-text-primary">{incident.type}</div>
                      <div className="text-xs text-text-tertiary mt-1">{incident.reporterName}</div>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      {incident.assignedResponder ? (
                        <div className="text-sm">
                          <div className="text-text-primary">{incident?.assignedResponder?.name}</div>
