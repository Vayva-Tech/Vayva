            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">Implemented</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">Business Needs</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                <Lightbulb size={48} className="mx-auto text-text-tertiary mb-4" />
              ...
              <div className="space-y-4">
                {filteredRequests.map((request) => (
                  <div 
                    key={request.id} 
                    className="border border-border/60 rounded-2xl p-5 hover:bg-surface/30 transition-colors"
                  >
