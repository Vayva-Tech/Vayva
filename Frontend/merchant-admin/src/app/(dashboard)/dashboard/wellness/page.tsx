  ...
  return (
    <div className="space-y-6 p-6 bg-background min-h-screen">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-foreground">VAYVA WELLNESS</h1>
          <p className="text-muted-foreground mt-1">Natural Warmth Design</p>
        </div>
            ...
            {mockData.appointments.map((apt, idx) => (
              <div key={idx} className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-muted-foreground">{apt.service} - {apt.staff}</div>
                </div>
        ...
        <WellnessCard title="🛍️ RETAIL SALES">
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t">
              ...
              <div className="text-xs text-muted-foreground">(clients purchasing products)</div>
            </div>
          </div>
        </WellnessCard>
      </div>
            ...
            {mockData.classes.map((classItem, idx) => (
              <div key={idx} className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Instructor: {classItem.instructor}</div>
                </div>
                <div className="text-right">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                <div className="text-2xl font-bold text-primary">{mockData.membershipMetrics.total}</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {Object.values(wellnessThemes).map((wellnessTheme) => (
            ...
            >
              ...
              />
              <div className="text-sm font-medium text-foreground">{wellnessTheme.name}</div>
              <div className="text-xs text-muted-foreground">{wellnessTheme.description}</div>
            </button>
          ))}
        </div>
      </WellnessCard>
