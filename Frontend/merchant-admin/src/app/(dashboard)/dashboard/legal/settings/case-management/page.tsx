  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-text-primary font-serif">Case Management</h1>
          <p className="text-text-secondary mt-1">Configure matter and case handling preferences</p>
        </div>
