  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-text-primary font-serif">Billing & Invoicing</h1>
          <p className="text-text-secondary mt-1">Configure billing rates, invoicing, and payment terms</p>
        </div>
