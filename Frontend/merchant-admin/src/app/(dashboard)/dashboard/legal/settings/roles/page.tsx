  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-text-primary font-serif">User Roles & Permissions</h1>
          <p className="text-text-secondary mt-1">Manage attorney, paralegal, and staff roles</p>
        </div>
        <Button>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">{role.users} users assigned</p>
                </div>
              </div>
