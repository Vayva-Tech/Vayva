  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-text-primary font-serif">Document Templates</h1>
          <p className="text-text-secondary mt-1">Manage document automation templates</p>
        </div>
        <Button>
            ...
            <div key={template.id} className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary capitalize">{template.category}</p>
                </div>
              </div>
