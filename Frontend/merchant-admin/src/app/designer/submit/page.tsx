...
export default function SubmitTemplatePage() {
  ...
  return (
    <div className="min-h-screen bg-white/40 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-2xl bg-background rounded-2xl shadow-xl overflow-hidden border border-border">
        {/* Header */}
        <div className="bg-text-primary p-8 text-white">
          <h1 className="text-2xl font-bold">Submit New Template</h1>
          <p className="text-text-tertiary mt-2">Step {step} of 3</p>
        </div>
        ...
        <div className="p-8">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div>
                ...
                <Input id="template-name"
                  ...
                  className="w-full border-border rounded-lg p-3 text-sm focus:ring-black focus:border-black"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    id="category"
                    className="w-full border-border rounded-lg p-3 text-sm"
              ...
              <Button
                ...
                className="w-full bg-black text-white py-3 rounded-xl font-bold hover:bg-text-primary disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Continue
              </Button>
            </div>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="border-2 border-dashed border-border rounded-xl p-12 text-center hover:border-black transition-colors cursor-pointer bg-white/40">
                <Icon
                  name="CloudUpload"
                  size={48}
              ...
              <div className="flex gap-4">
                <Button
                  onClick={() => setStep(1)}
                  className="flex-1 bg-white/40 text-text-primary py-3 rounded-xl font-bold"
                >
                  Back
                </Button>
                <Button
                  onClick={handleSubmit}
                  className="flex-1 bg-black text-white py-3 rounded-xl font-bold hover:bg-text-primary"
                >
