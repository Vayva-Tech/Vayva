                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={cn(
                      ...
                      industry.category === 'glass' && "bg-gradient-to-r from-pink-500 to-rose-500",
                      industry.category === 'bold' && "bg-orange-500",
                      industry.category === 'dark' && "bg-gray-800",
                      industry.category === 'natural' && "bg-amber-500",
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className={cn(
                ...
                selectedIndustry.category === 'natural' && "bg-amber-100 text-amber-800",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                },
                {
                  ...
                  bgColor: 'bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50'
                },
                {
                  category: 'bold',
                  title: 'Bold Energy',
