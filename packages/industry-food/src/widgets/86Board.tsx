...
import { Card, CardContent, CardHeader, Badge } from '@vayva/ui';
...
export function EightySixBoard({
  ...
  const cardClass = ['bg-gradient-to-br', getGradientClass(), className].filter(Boolean).join(' ');
    ...
    <Card className={cardClass}>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Badge variant={unavailableItems.length > 0 ? 'error' : 'success'}>
