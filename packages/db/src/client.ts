...
// Explicit type exports for downstream imports (keeps TS happy even if wildcard type export is not picked up)
export type {
  SizeChart,
  SizeProfile,
  StyleQuiz,
...
export function getIsolatedPrisma(): PrismaClient {
