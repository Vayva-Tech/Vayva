...
import { Tote } from "@phosphor-icons/react/dist/ssr/Tote";
...
// Re-export with aliases to match expected API
...
// Map Lucide names (kebab-case or PascalCase) to Phosphor components
export const ICON_MAP: Record<string, React.ElementType> = {
  ...
  // Aliases to maintain Lucide compatibility where names changed
  "refresh-cw": History,
  "chevron-right": CaretRight,
  "chevron-down": CaretDown,
  "external-link": ArrowUpRight,
  "alert-triangle": ShieldWarning,
  ...
  bitcoin: CurrencyDollar,
  "heart-pulse": Activity,
  zap: Lightning,
  "thumbs-up": ThumbsUp,
  "thumbs-down": ThumbsUp,
  star: Star,
  "star-half": Star,
  bookmark: Tag,
  "message-square": HandWaving,
  hash: Path,
  at: EnvelopeSimple,
  globe: Globe,
  link: Link,
  ...
  archive: Package,
  clipboard: FileText,
  "clipboard-list": ListBullets,
  "clipboard-check": CheckCircle,
  "clipboard-x": XCircle,
  // Additional sidebar icon aliases
  dashboard: Layout,
  layoutdashboard: Layout,
  "layout-dashboard": Layout,
  "bar-chart-3": ChartBar,
  barchart3: ChartBar,
  megaphone: SpeakerHigh,
  lifebuoy: Info,
  "life-buoy": Info,
  support: Info,
  folder: Stack,
