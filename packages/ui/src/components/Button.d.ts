...
declare const buttonVariants: (props?: ({
    variant?: "link" | "primary" | "secondary" | "outline" | "ghost" | "destructive" | "danger" | null | undefined;
...
export declare function Button({ className, variant, size, isLoading, children, ...props }: ButtonProps): React.DetailedReactHTMLElement<{
    asChild?: boolean;
    "aria-label"?: string;
    disabled: boolean;
