...
export const DonationTracker: React.FC<DonationTrackerProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <DashboardErrorBoundary serviceName="DonationTrackerHeader">
      ...
      {/* Progress Bar */}
      <DashboardErrorBoundary serviceName="DonationTrackerProgress">
        <div className="mb-6">
      ...
      {/* Stats Grid */}
      <DashboardErrorBoundary serviceName="DonationTrackerStats">
      ...
      {/* Recent Donations */}
      <DashboardErrorBoundary serviceName="DonationTrackerList">
