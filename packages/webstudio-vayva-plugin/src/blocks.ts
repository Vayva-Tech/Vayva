import { getBlocksForExtensions, COMMERCE_BLOCKS, CommerceBlockDef } from "@vayva/shared";
...
export const getCommerceBlocks = (enabledExtensionIds?: string[]): CommerceBlockDef[] => {
  if (enabledExtensionIds && enabledExtensionIds.length > 0) {
    return getBlocksForExtensions(enabledExtensionIds);
  }
 ...
 */
export const generateBlockHtml = (blockKey: string, props: Record<string, any>): string => {
