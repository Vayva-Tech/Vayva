...
exports.SYSTEM_TEMPLATE_COUNT = exports.SYSTEM_TEMPLATES = exports.TEMPLATE_THUMBNAIL_STANDARDS = void 0;
exports.getSystemTemplateByKey = getSystemTemplateByKey;
exports.getSystemTemplateCategories = getSystemTemplateCategories;
/**
 * Standard for Template Thumbnails (Wix-like premium feel)
 */
exports.TEMPLATE_THUMBNAIL_STANDARDS = {
    aspectRatio: "16:10",
    background: "#0B0F0D",
...
exports.SYSTEM_TEMPLATE_COUNT = exports.SYSTEM_TEMPLATES.length;
function getSystemTemplateByKey(key) {
    return exports.SYSTEM_TEMPLATES.find((t) => t.key === key);
}
function getSystemTemplateCategories() {
    return [...new Set(exports.SYSTEM_TEMPLATES.map((t) => t.category))];
}
