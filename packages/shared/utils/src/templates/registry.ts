...
export const SYSTEM_TEMPLATES: SystemTemplate[] = [
  {
    ...
    category: "Fashion",
    description:
      "Bold fashion storefront with lookbook-style layouts and collection grids.",
  ...
  },
  {
    ...
    category: "Content",
    description:
      "Clean editorial layout for articles, newsletters, and content marketing.",
  ...
  },
  {
    ...
    description:
      "Elegant home décor storefront with curated collections and lifestyle imagery.",
  ...
  },
  {
    ...
    category: "Bookings",
    description:
      "Appointment and service booking with calendar integration and staff profiles.",
  ...
  },
  {
    ...
    category: "Wholesale",
    description:
      "B2B wholesale storefront with bulk pricing, MOQ, and quote requests.",
  ...
  },
  {
    ...
    category: "Food & Drink",
    description:
      "Restaurant and food delivery storefront with menu builder and order tracking.",
  ...
  },
  {
    ...
    category: "Education",
    description:
      "Online course platform with lesson modules, progress tracking, and certificates.",
  ...
  },
  {
    ...
    description:
      "Sell digital downloads — ebooks, templates, presets, and software.",
  ...
  },
  {
    ...
    description:
      "Donation and fundraising campaigns with progress bars and donor walls.",
  ...
  },
  {
    ...
    description:
      "Tech and gadget storefront with spec comparisons and review sections.",
  ...
  },
  {
    ...
    description:
      "Property listings with maps, virtual tours, and agent contact forms.",
  ...
  },
  {
    ...
    description:
      "High-conversion single-product landing page with testimonials and CTAs.",
  ...
  },
  {
    ...
    category: "Events",
    description:
      "Event ticketing with seat selection, countdown timers, and QR check-in.",
  ...
  },
  {
    ...
    category: "Travel",
    description:
      "Travel and tour booking with itineraries, galleries, and availability calendars.",
...
export function getSystemTemplateByKey(
  key: string,
