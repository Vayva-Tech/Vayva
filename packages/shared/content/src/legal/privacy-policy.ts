...
export const privacyPolicy: LegalDocument = {
  ...
  summary:
    "How we collect, use, and protect personal data when you use the Vayva platform.",
  sections: [
    {
    ...
    },
    {
      ...
      content: [
        "Vayva Tech is responsible for personal data processed for the Service. Contact us at privacy@vayva.ng.",
      ],
    },
    {
      ...
      content: [
        ...
        "We collect verification data such as identity details, business registration details, and documents you submit for KYC and compliance checks.",
        ...
        "We collect usage data such as log data, device and browser information, and analytics events.",
    ...
    },
    {
      ...
      content: [
        "Data may be processed in Nigeria or other countries where our providers operate. We use contractual safeguards and security controls.",
      ],
    },
    {
      heading: "8. Retention",
      content: [
        "We keep data only as long as needed for the purposes described in this policy, including compliance and audit requirements.",
      ],
    },
    {
    ...
    {
      heading: "14. Contact",
      content: ["Email: privacy@vayva.ng"],
    },
  ],
};
