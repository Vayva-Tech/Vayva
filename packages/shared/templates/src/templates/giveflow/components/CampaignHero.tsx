...
export const CampaignHero = ({
  ...
  React.useEffect(() => {
    if (details && progressBarRef.current) {
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-8 relative z-10 grid md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-4 space-y-6">
          <div className="bg-transparent border border-gray-200 rounded-xl p-6 shadow-sm sticky top-24">
            ...
            <Button
              variant="outline"
              className="w-full bg-transparent border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-bold py-3 rounded-xl transition-colors h-auto"
