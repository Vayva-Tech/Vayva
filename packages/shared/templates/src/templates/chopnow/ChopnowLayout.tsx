...
export const ChopnowLayout = ({
  store,
  products,
}: ChopnowLayoutProps): React.JSX.Element => {
  ...
  return (
    <div className="min-h-screen bg-background/40 backdrop-blur-sm font-sans text-gray-900 pb-20">
      <ChopnowHeader />
      <FoodHero />
