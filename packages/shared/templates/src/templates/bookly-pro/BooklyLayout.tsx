...
export const BooklyLayout = ({
  store,
  products,
}: BooklyLayoutProps): React.JSX.Element => {
  const [selectedService, setSelectedService] = useState<PublicProduct | null>(
    null,
  );
  const [bookingSuccess, setBookingSuccess] = useState<BookingDetails | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-background/40 backdrop-blur-sm font-sans text-gray-900">
