...
export const Paystack = {
    async createCustomer(args) {
        ...
        const customerCode = typeof json.data.customer_code === "string" ? json.data.customer_code : "";
        if (!customerCode) {
    ...
    async createDedicatedVirtualAccount(args) {
        ...
        const accountNumber = typeof json.data.account_number === "string" ? json.data.account_number : "";
        const accountName = typeof json.data.account_name === "string" ? json.data.account_name : "";
        const bankName = isRecord(json.data.bank) && typeof json.data.bank.name === "string"
            ? json.data.bank.name
            : "";
        const providerRef = typeof json.data.dedicated_account_id === "number"
    ...
    async initializeTransaction(args) {
        ...
        if (!args.callbackUrl)
            throw new Error("callbackUrl required");
    ...
    async verifyTransaction(reference) {
        ...
        return {
            ...
            gatewayResponse: typeof data.gateway_response === "string"
    ...
    async resolveAccount(accountNumber, bankCode) {
        ...
        const resolvedAccountNumber = typeof json.data.account_number === "string"
            ? json.data.account_number
            : "";
        const accountName = typeof json.data.account_name === "string" ? json.data.account_name : "";
        const bankId = typeof json.data.bank_id === "number" ? json.data.bank_id : NaN;
