...
export const EventPayloads = {
  ...
  [EventName.TEMPLATE_PREVIEWED]: z.object({
    ...
    templateTier: z.enum(["free", "starter", "pro"]),
  }),
  ...
  [EventName.PLAN_LIMIT_REACHED]: z.object({
    currentTier: z.enum(["free", "starter", "pro"]),
    limitType: z.string(),
  }),
  [EventName.UPGRADE_PROMPT_SHOWN]: z.object({
    currentTier: z.enum(["free", "starter", "pro"]),
    targetTier: z.enum(["starter", "pro"]),
    promptContext: z.string().optional(),
  }),
  [EventName.UPGRADE_COMPLETED]: z.object({
    previousTier: z.enum(["free", "starter", "pro"]),
    newTier: z.enum(["starter", "pro"]),
  }),
};
