    ...
    <VayvaGlowLayout
      ...
      body={
        <>
          ...
          <strong style={{ color: "#E8FFF2" }}>{props.refCode}</strong>.
          You must respond with evidence before the deadline to avoid an automatic resolution in the customer's favour.
        </>
      }
      ...
      calloutText={
        <>
          <span style={{ color: "#F87171", fontWeight: 800 }}>{props.responseDeadline}</span>
          <br />
          <span style={{ fontSize: 12, color: "#94A3B8" }}>Reason: {props.reason}</span>
        </>
      }
      ...
      footerNote={
        <>
          Provide clear evidence (screenshots, tracking info, communication logs) to support your case.
          <br />
