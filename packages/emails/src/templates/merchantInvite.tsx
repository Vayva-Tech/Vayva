...
export function MerchantInviteEmail(props: {
  ...
  return (
    <VayvaGlowLayout
      ...
      body={
        <>
          <strong style={{ color: "#E8FFF2" }}>{props.inviterName}</strong> invited you to collaborate in Vayva Merchant
          Admin. Your access will match the role assigned to you.
        </>
      }
      ...
      footerNote={
        <>
          ...
          <br />
          Need help? Reply here or contact <span style={{ color: "#E8FFF2" }}>support@vayva.ng</span>.
        </>
      }
    />
  );
