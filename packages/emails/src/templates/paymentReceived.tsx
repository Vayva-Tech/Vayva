...
export function PaymentReceivedEmail(props: {
  ...
  return (
    <VayvaGlowLayout
      ...
      body={<>Your payment has been confirmed. We’ll continue processing your order.</>}
      calloutIcon={<IconCheck />}
      calloutTitle="Payment reference"
      calloutText={<span style={{ color: "#E8FFF2", fontWeight: 800 }}>{props.paymentReference}</span>}
      ctaText="See receipt"
