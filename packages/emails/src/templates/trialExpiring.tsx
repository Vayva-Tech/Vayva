...
export function TrialExpiringEmail(props: {
  ...
  return (
    <VayvaGlowLayout
      ...
      body={
        <>
          Your free trial for <strong style={{ color: "#E8FFF2" }}>{props.storeName}</strong> is ending soon.
          Upgrade now to keep your store live, retain your products, and continue accepting payments.
        </>
      }
      ...
      calloutText={
        <>
          After your trial ends, your storefront will be paused until you subscribe.
          Your data will be kept safe — nothing is deleted.
        </>
      }
      ctaText="Upgrade now"
      ...
      footerNote={
        <>
          Plans start at just &#8358;20,000/month. See all plans on your billing page.
          <br />
