...
export const BottleServiceDashboard: React.FC<BottleServiceDashboardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <DashboardErrorBoundary serviceName="BottleServiceHeader">
      ...
      {/* Stats Grid */}
      <DashboardErrorBoundary serviceName="BottleServiceStats">
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* Active Orders */}
        <DashboardErrorBoundary serviceName="BottleServiceActiveOrders">
          <div>
        ...
        {/* Inventory Status */}
        <DashboardErrorBoundary serviceName="BottleServiceInventory">
          <div>
