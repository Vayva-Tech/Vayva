...
export const dataProcessingAgreement: LegalDocument = {
  ...
  version: "1.0",
  summary:
    "This Data Processing Agreement governs the processing of personal data in accordance with GDPR, NDPR, and other applicable data protection laws.",
  sections: [
    {
      heading: "1. Definitions and Interpretation",
      content: [
        "In this Agreement, unless the context otherwise requires: 'Controller' means the entity that determines the purposes and means of processing personal data; 'Processor' means Vayva Tech as the entity that processes personal data on behalf of the Controller; 'Personal Data' means any information relating to an identified or identifiable natural person; 'Processing' means any operation performed on personal data; 'GDPR' means the EU General Data Protection Regulation (EU) 2016/679; 'NDPR' means the Nigeria Data Protection Regulation 2019.",
      ],
      type: "definitions",
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "Vayva shall not engage another processor (subprocessor) without prior specific or general written authorization. Vayva maintains a public list of authorized subprocessors at vayva.ng/subprocessors.",
      ],
      type: "text",
    },
    {
      ...
      content: [
        "Where Personal Data is transferred outside the jurisdiction in which it was collected, Vayva shall ensure appropriate safeguards are in place. For transfers from the EEA, UK, or Nigeria to third countries, Vayva relies on adequacy decisions, Standard Contractual Clauses (SCCs), Binding Corporate Rules, or other lawful transfer mechanisms.",
        "Vayva uses cloud infrastructure providers with data centers in multiple jurisdictions. Merchant data may be processed wherever Vayva or its subprocessors operate facilities.",
      ],
      type: "text",
    },
    {
    ...
    },
    {
      ...
      content: [
        "This Agreement is governed by the laws of the Federal Republic of Nigeria. For Merchants established in the EEA or UK, parties may elect to have disputes resolved in the courts of the Merchant's establishment.",
        "Notwithstanding the foregoing, data subjects may bring claims in their jurisdiction of residence as permitted by applicable Data Protection Laws.",
      ],
      type: "text",
    },
    {
      ...
      content: [
        "For questions about this DPA or to exercise data protection rights, contact Vayva's Data Protection Officer at: dpo@vayva.ng or Data Protection Compliance, Vayva Tech, Lagos, Nigeria.",
      ],
      type: "text",
    },
  ],
