    ...
    <header className="sticky top-0 z-50 bg-transparent/90 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" className="flex items-center gap-2 bg-background/50 backdrop-blur-sm hover:bg-gray-200 text-gray-900 px-4 py-2 rounded-full text-xs font-bold transition-colors h-auto" aria-label="Track order">
            <ShoppingBag size={14} />
