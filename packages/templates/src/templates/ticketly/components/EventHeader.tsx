    ...
    <header className="sticky top-0 z-50 bg-transparent/90 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" className="hidden sm:flex items-center gap-2 text-sm font-bold text-gray-900 bg-background/50 backdrop-blur-sm hover:bg-gray-200 px-4 py-2 rounded-full transition-colors h-auto" aria-label="View my tickets">
