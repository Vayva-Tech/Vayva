...
export const AuthLeftPanel = ({ variant = "support" }: AuthLeftPanelProps) => {
  const content = (() => {
    switch (variant) {
      case "signin":
        return {
  ...
  return (
    <div className="hidden lg:flex lg:w-[38%] shrink-0 h-full bg-white/60 backdrop-blur-xl flex-col justify-between p-8 relative overflow-hidden border-r border-emerald-100/40">
      {/* Background Ambience — green blurs */}
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-400/8 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2" />
