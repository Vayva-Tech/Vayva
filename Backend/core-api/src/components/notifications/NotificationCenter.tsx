...
import { Notification, logger } from "@vayva/shared";
...
export const NotificationCenter = ({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-16 right-4 bottom-4 w-full max-w-sm bg-background rounded-2xl shadow-2xl border border-border z-50 flex flex-col overflow-hidden animate-in slide-in-from-right-4 duration-300">
        {/* Header */}
        <div className="p-4 border-b border-border/40 flex justify-between items-center bg-background/80 backdrop-blur sticky top-0 z-10">
          <div>
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    filter === f
                      ...
                      : "bg-white/40 text-text-tertiary hover:bg-border",
                  )}
                >
                  {f}
                </Button>
        ...
        {/* Footer */}
        <div className="p-3 bg-white/40 border-t border-border/40 text-center">
          <Link
            href="/dashboard/settings/notifications"
            className="text-xs font-bold text-text-tertiary hover:text-text-primary transition-colors"
          >
            Manage Preferences
          </Link>
        </div>
