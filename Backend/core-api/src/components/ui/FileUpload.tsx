...
interface FileUploadProps {
  ...
  label?: string;
  maxSizeMB?: number;
  purpose: "PRODUCT_IMAGE" | "BRANDING_LOGO" | "DISPUTE_EVIDENCE";
  entityId?: string; // Optional for branding, required for products/disputes
}
...
export function FileUpload({
  ...
  if (value) {
    return (
      <div className="relative border rounded-lg p-4 flex items-center gap-3 bg-white/40">
  ...
  return (
    <div className="w-full">
      <label className="cursor-pointer border-2 border-dashed border-border rounded-xl p-6 flex flex-col items-center justify-center bg-white/40 hover:bg-white/40 transition-colors gap-2 text-center relative">
        {uploading ? (
          <>
