      ...
      <main className="flex-1 ml-[300px] min-h-screen flex flex-col">
        ...
        <header className="h-[72px] border-b border-white/5 bg-[#142210]/90 backdrop-blur sticky top-0 z-40 px-8 flex items-center justify-between gap-8">
          ...
          <div className="flex-1 max-w-2xl relative">
            ...
            />
            <input
              className="w-full bg-background/5 border border-white/10 rounded-full pl-10 pr-4 py-2 text-sm text-white focus:outline-none focus:border-white/20 placeholder:text-text-secondary transition-all"
              type="search"
