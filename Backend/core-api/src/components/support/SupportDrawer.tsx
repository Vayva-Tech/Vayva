...
import { Button, Drawer, Icon, type IconName } from "@vayva/ui";
...
export const SupportDrawer = ({ isOpen, onClose }: SupportDrawerProps) => {
        ...
        if (formSuccess) {
          return (
            <div className="text-center py-8 space-y-4">
              ...
              <h3 className="font-bold text-text-primary">Ticket Submitted</h3>
            ...
            <form onSubmit={handleSubmitTicket} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-border rounded-lg text-sm focus:ring-2 focus:ring-indigo-100 outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-border rounded-lg text-sm focus:ring-2 focus:ring-indigo-100 outline-none resize-y"
                  disabled={formLoading}
                />
              </div>
              {formError && (
...
const CategoryButton = ({
  ...
  <Button
    onClick={onClick}
    className="flex flex-col items-center justify-center p-4 bg-background border border-border rounded-lg hover:border-text-primary transition-colors"
    variant="outline"
  >
    <Icon name={icon} size={24} className="mb-2 text-text-secondary" />
