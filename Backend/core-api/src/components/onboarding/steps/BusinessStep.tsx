...
export default function BusinessStep() {
  ...
  const [registeredAddress, setRegisteredAddress] = useState(
    currentState.business?.registeredAddress || {},
  );
  const [pickupAddressObj, setPickupAddressObj] = useState(
    currentState.logistics?.pickupAddressObj || {},
  );
    ...
    <div className="space-y-6">
      <div className="text-center space-y-1.5">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-border/40 mb-2">
          <Store size={24} className="text-text-tertiary" />
        </div>
      ...
      <div className="bg-background border border-border rounded-3xl p-6 shadow-card space-y-6">
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            className="h-12 rounded-xl border-2 border-border focus:border-vayva-green font-semibold bg-white/30"
            disabled={isSaving}
          >
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center relative min-w-0">
            <span className="bg-white/40 border-2 border-border rounded-xl px-4 py-2 text-sm font-bold text-text-secondary shrink-0 order-2 ml-2 h-12 flex items-center">
              .{urls.storefrontRoot()}
            </span>
            <Input
              id="slug"
              ...
              className="rounded-xl pr-10 flex-1 min-w-0 h-12 border-2 border-border focus:border-vayva-green focus:ring-vayva-green font-bold text-lg"
            ...
            <div className="flex items-center justify-between ml-1">
              ...
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border-border text-vayva-green focus:ring-vayva-green"
                  disabled={isSaving}
                />
