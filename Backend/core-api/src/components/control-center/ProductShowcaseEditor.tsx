      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <p className="text-[10px] text-text-tertiary">Smart selection</p>
          </Button>
          <Button
            variant="ghost"
          ...
          >
            ...
            <p className="text-[10px] text-text-tertiary">Pick products</p>
          </Button>
        </div>
      </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-sm border border-border rounded-lg pl-9 pr-3 py-2 focus:ring-1 focus:ring-black outline-none"
              />
            </div>
