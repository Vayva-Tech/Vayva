...
export const CalendarSyncSettings = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {syncs.length > 0 && (
        <div className="flex flex-col gap-2">
          {syncs.map((sync) => (
            <div
              key={sync.id}
              className="bg-background/5 border border-white/10 rounded-lg p-3 flex items-center justify-between"
            >
              <div className="flex flex-col gap-1 overflow-hidden">
                ...
                <span className="text-xs text-text-secondary truncate text-ellipsis max-w-[200px]">
                  {sync.url}
                </span>
                {sync.lastSyncedAt && (
      ...
      {isAdding ? (
        <div className="bg-background/5 border border-white/10 rounded-lg p-4 flex flex-col gap-3">
        ...
        <Button
          variant="outline"
          className="w-full border-dashed border-white/20 hover:border-white/40 text-text-secondary"
