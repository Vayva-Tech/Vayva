  ...
  return (
    <Card className="w-full max-w-sm mx-auto p-6">
      ...
      <div className="flex flex-col items-center gap-6">
        <div className="bg-background p-4 rounded-xl border-2 border-dashed border-border">
          <QRCodeSVG
            value={trackingUrl}
            size={200}
            level="H"
        ...
        <p className="text-xs text-center text-text-tertiary max-w-[250px]">
          Place this on your counter, packaging, or flyers to drive offline
