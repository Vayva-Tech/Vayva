          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="mt-2 p-3 bg-green-50 dark:bg-green-900/10 rounded-lg border border-green-100 dark:border-green-900/20">
                ...
                <p className="text-sm text-text-primary dark:text-text-tertiary whitespace-pre-wrap">
          ...
          <TableBody>
            {templates?.map((t) => (
              <TableRow key={t.id as string}>
                ...
                <TableCell>{t.language as string}</TableCell>
                <TableCell>{getStatusBadge(t.status as string)}</TableCell>
                <TableCell>
                  {format(new Date(t.createdAt as string), "MMM d, yyyy")}
                </TableCell>
                <TableCell className="text-right">
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      setConfirmDelete({ open: true, id: t.id as string })
                    }
                  >
