...
export function sanitizeFormData(
  ...
  for (const [key, value] of Object.entries(data)) {
    ...
    // The provided instruction for `catch (error: unknown) { throw error; }` was syntactically incorrect
    // at this location. Assuming it was a misplaced snippet or an incomplete instruction,
    // I'm proceeding with the original logic for null/undefined values.
    // If a try/catch block was intended here, please provide the full context.
